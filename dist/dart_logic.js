...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      $.$get$_context().$indexSet(0, "handleTerminalDart", new A.main_closure());
    },
  ...
  (function inheritance() {
    ...
    _inherit(A.main_closure, A.Closure0Args);
...
//# sourceMappingURL=dart_logic.js.map
