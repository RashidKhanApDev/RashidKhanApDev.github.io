...
`)+`
`+m);let S=v+p+a,M=v+m+o,A=jp(i,i.VERTEX_SHADER,S),w=jp(i,i.FRAGMENT_SHADER,M);i.attachShader(_,A),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function E(I){if(r.debug.checkShaderErrors){let P=i.getProgramInfoLog(_)||"",B=i.getShaderInfoLog(A)||"",z=i.getShaderInfoLog(w)||"",L=P.trim(),O=B.trim(),U=z.trim(),Z=!0,j=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,A,w);else{let D=tm(i,A,"vertex"),de=tm(i,w,"fragment");Ve("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`,lf=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Ya(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new jn({vertexShader:eS,fragmentShader:tS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Rn(new ss(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},cf=class extends Fi{constructor(e,t){super();let n=this,i=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,d=null,h=null,f=null,g=null,_=typeof XRWebGLBinding<"u",p=new lf,m={},v=t.getContextAttributes(),S=null,M=null,A=[],w=[],E=new ft,x=null,b=new _n;b.viewport=new Ot;let R=new _n;R.viewport=new Ot;let I=[b,R],P=new Jl,B=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let oe=A[$];return oe===void 0&&(oe=new Zs,A[$]=oe),oe.getTargetRaySpace()},this.getControllerGrip=function($){let oe=A[$];return oe===void 0&&(oe=new Zs,A[$]=oe),oe.getGripSpace()},this.getHand=function($){let oe=A[$];return oe===void 0&&(oe=new Zs,A[$]=oe),oe.getHandSpace()};function L($){let oe=w.indexOf($.inputSource);if(oe===-1)return;let se=A[oe];se!==void 0&&(se.update($.inputSource,$.frame,c||a),se.dispatchEvent({type:$.type,data:$.inputSource}))}function O(){i.removeEventListener("select",L),i.removeEventListener("selectstart",L),i.removeEventListener("selectend",L),i.removeEventListener("squeeze",L),i.removeEventListener("squeezestart",L),i.removeEventListener("squeezeend",L),i.removeEventListener("end",O),i.removeEventListener("inputsourceschange",U);for(let $=0;$<A.length;$++){let oe=w[$];oe!==null&&(w[$]=null,A[$].disconnect(oe))}B=null,z=null,p.reset();for(let $ in m)delete m[$];e.setRenderTarget(S),f=null,h=null,d=null,i=null,M=null,Ie.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(E.width,E.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){s=$,n.isPresenting===!0&&ke("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){o=$,n.isPresenting===!0&&ke("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function($){c=$},this.getBaseLayer=function(){return h!==null?h:f},this.getBinding=function(){return d===null&&_&&(d=new XRWebGLBinding(i,t)),d},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function($){if(i=$,i!==null){if(S=e.getRenderTarget(),i.addEventListener("select",L),i.addEventListener("selectstart",L),i.addEventListener("selectend",L),i.addEventListener("squeeze",L),i.addEventListener("squeezestart",L),i.addEventListener("squeezeend",L),i.addEventListener("end",O),i.addEventListener("inputsourceschange",U),v.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(E),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let se=null,Ee=null,Fe=null;v.depth&&(Fe=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,se=v.stencil?Nr:Ui,Ee=v.stencil?na:Ei);let Ce={colorFormat:t.RGBA8,depthFormat:Fe,scaleFactor:s};d=this.getBinding(),h=d.createProjectionLayer(Ce),i.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),M=new $n(h.textureWidth,h.textureHeight,{format:pi,type:ti,depthTexture:new nr(h.textureWidth,h.textureHeight,Ee,void 0,void 0,void 0,void 0,void 0,void 0,se),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{let se={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};f=new XRWebGLLayer(i,t,se),i.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new $n(f.framebufferWidth,f.framebufferHeight,{format:pi,type:ti,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await i.requestReferenceSpace(o),Ie.setContext(i),Ie.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function U($){for(let oe=0;oe<$.removed.length;oe++){let se=$.removed[oe],Ee=w.indexOf(se);Ee>=0&&(w[Ee]=null,A[Ee].disconnect(se))}for(let oe=0;oe<$.added.length;oe++){let se=$.added[oe],Ee=w.indexOf(se);if(Ee===-1){for(let Ce=0;Ce<A.length;Ce++)if(Ce>=w.length){w.push(se),Ee=Ce;break}else if(w[Ce]===null){w[Ce]=se,Ee=Ce;break}if(Ee===-1)break}let Fe=A[Ee];Fe&&Fe.connect(se)}}let Z=new W,j=new W;function D($,oe,se){Z.setFromMatrixPosition(oe.matrixWorld),j.setFromMatrixPosition(se.matrixWorld);let Ee=Z.distanceTo(j),Fe=oe.projectionMatrix.elements,Ce=se.projectionMatrix.elements,je=Fe[14]/(Fe[10]-1),Te=Fe[14]/(Fe[10]+1),ze=(Fe[9]+1)/Fe[5],$e=(Fe[9]-1)/Fe[5],Be=(Fe[8]-1)/Fe[0],X=(Ce[8]+1)/Ce[0],at=je*Be,It=je*X,F=Ee/(-Be+X),Ze=F*-Be;if(oe.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Ze),$.translateZ(F),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Fe[10]===-1)$.projectionMatrix.copy(oe.projectionMatrix),$.projectionMatrixInverse.copy(oe.projectionMatrixInverse);else{let We=je+F,lt=Te+F,pe=at-Ze,Ke=It+(Ee-Ze),C=ze*Te/lt*We,y=$e*Te/lt*We;$.projectionMatrix.makePerspective(pe,Ke,C,y,We,lt),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function de($,oe){oe===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(oe.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(i===null)return;let oe=$.near,se=$.far;p.texture!==null&&(p.depthNear>0&&(oe=p.depthNear),p.depthFar>0&&(se=p.depthFar)),P.near=R.near=b.near=oe,P.far=R.far=b.far=se,(B!==P.near||z!==P.far)&&(i.updateRenderState({depthNear:P.near,depthFar:P.far}),B=P.near,z=P.far),P.layers.mask=$.layers.mask|6,b.layers.mask=P.layers.mask&-5,R.layers.mask=P.layers.mask&-3;let Ee=$.parent,Fe=P.cameras;de(P,Ee);for(let Ce=0;Ce<Fe.length;Ce++)de(Fe[Ce],Ee);Fe.length===2?D(P,b,R):P.projectionMatrix.copy(b.projectionMatrix),be($,P,Ee)};function be($,oe,se){se===null?$.matrix.copy(oe.matrixWorld):($.matrix.copy(se.matrixWorld),$.matrix.invert(),$.matrix.multiply(oe.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(oe.projectionMatrix),$.projectionMatrixInverse.copy(oe.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=Rl*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return P},this.getFoveation=function(){if(!(h===null&&f===null))return l},this.setFoveation=function($){l=$,h!==null&&(h.fixedFoveation=$),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=$)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(P)},this.getCameraTexture=function($){return m[$]};let Xe=null;function Oe($,oe){if(u=oe.getViewerPose(c||a),g=oe,u!==null){let se=u.views;f!==null&&(e.setRenderTargetFramebuffer(M,f.framebuffer),e.setRenderTarget(M));let Ee=!1;se.length!==P.cameras.length&&(P.cameras.length=0,Ee=!0);for(let Te=0;Te<se.length;Te++){let ze=se[Te],$e=null;if(f!==null)$e=f.getViewport(ze);else{let X=d.getViewSubImage(h,ze);$e=X.viewport,Te===0&&(e.setRenderTargetTextures(M,X.colorTexture,X.depthStencilTexture),e.setRenderTarget(M))}let Be=I[Te];Be===void 0&&(Be=new _n,Be.layers.enable(Te),Be.viewport=new Ot,I[Te]=Be),Be.matrix.fromArray(ze.transform.matrix),Be.matrix.decompose(Be.position,Be.quaternion,Be.scale),Be.projectionMatrix.fromArray(ze.projectionMatrix),Be.projectionMatrixInverse.copy(Be.projectionMatrix).invert(),Be.viewport.set($e.x,$e.y,$e.width,$e.height),Te===0&&(P.matrix.copy(Be.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale)),Ee===!0&&P.cameras.push(Be)}let Fe=i.enabledFeatures;if(Fe&&Fe.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&_){d=n.getBinding();let Te=d.getDepthInformation(se[0]);Te&&Te.isValid&&Te.texture&&p.init(Te,i.renderState)}if(Fe&&Fe.includes("camera-access")&&_){e.state.unbindTexture(),d=n.getBinding();for(let Te=0;Te<se.length;Te++){let ze=se[Te].camera;if(ze){let $e=m[ze];$e||($e=new Ya,m[ze]=$e);let Be=d.getCameraImage(ze);$e.sourceTexture=Be}}}}for(let se=0;se<A.length;se++){let Ee=w[se],Fe=A[se];Ee!==null&&Fe!==void 0&&Fe.update(Ee,oe,c||a)}Xe&&Xe($,oe),oe.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:oe}),g=null}let Ie=new um;Ie.setAnimationLoop(Oe),this.setAnimationLoop=function($){Xe=$},this.dispose=function(){}}},nS=new Ft,gm=new Ye;gm.set(-1,0,0,0,1,0,0,0,1);sS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),zi=null;Gc=class{constructor(e={}){let{canvas:t=Up(),context:n=null,depth:i=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1,outputBufferType:f=ti}=e;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;let _=f,p=new Set([sc,rc,ic]),m=new Set([ti,Ei,ta,na,tc,nc]),v=new Uint32Array(4),S=new Int32Array(4),M=new W,A=null,w=null,E=[],x=[],b=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=wi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,I=!1,P=null;this._outputColorSpace=Kn;let B=0,z=0,L=null,O=-1,U=null,Z=new Ot,j=new Ot,D=null,de=new dt(0),be=0,Xe=t.width,Oe=t.height,Ie=1,$=null,oe=null,se=new Ot(0,0,Xe,Oe),Ee=new Ot(0,0,Xe,Oe),Fe=!1,Ce=new Wa,je=!1,Te=!1,ze=new Ft,$e=new W,Be=new Ot,X={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},at=!1;function It(){return L===null?Ie:1}let F=n;function Ze(T,k){return t.getContext(T,k)}try{let T={alpha:!0,depth:i,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"184"}`),t.addEventListener("webglcontextlost",te,!1),t.addEventListener("webglcontextrestored",re,!1),t.addEventListener("webglcontextcreationerror",ue,!1),F===null){let k="webgl2";if(F=Ze(k,T),F===null)throw Ze(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw Ve("WebGLRenderer: "+T.message),T}let We,lt,pe,Ke,C,y,V,J,ee,he,ne,Y,Q,ge,Se,fe,le,me,Ge,qe,N,ae,K;function xe(){We=new dy(F),We.init(),N=new jM(F,We),lt=new sy(F,We,e,N),pe=new $M(F,We),lt.reversedDepthBuffer&&h&&pe.buffers.depth.setReversed(!0),Ke=new gy(F),C=new OM,y=new QM(F,We,pe,C,lt,N,Ke),V=new fy(R),J=new y0(F),ae=new iy(F,J),ee=new py(F,J,Ke,ae),he=new xy(F,ee,J,ae,Ke),me=new _y(F,lt,y),Se=new ay(C),ne=new FM(R,V,We,lt,ae,Se),Y=new iS(R,C),Q=new kM,ge=new XM(We),le=new ny(R,V,pe,he,g,l),fe=new KM(R,he,lt),K=new rS(F,Ke,lt,pe),Ge=new ry(F,We,Ke),qe=new my(F,We,Ke),Ke.programs=ne.programs,R.capabilities=lt,R.extensions=We,R.properties=C,R.renderLists=Q,R.shadowMap=fe,R.state=pe,R.info=Ke}xe(),_!==ti&&(b=new yy(_,t.width,t.height,i,s));let ce=new cf(R,F);this.xr=ce,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let T=We.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){let T=We.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return Ie},this.setPixelRatio=function(T){T!==void 0&&(Ie=T,this.setSize(Xe,Oe,!1))},this.getSize=function(T){return T.set(Xe,Oe)},this.setSize=function(T,k,q=!0){if(ce.isPresenting){ke("WebGLRenderer: Can't change size while VR device is presenting.");return}Xe=T,Oe=k,t.width=Math.floor(T*Ie),t.height=Math.floor(k*Ie),q===!0&&(t.style.width=T+"px",t.style.height=k+"px"),b!==null&&b.setSize(t.width,t.height),this.setViewport(0,0,T,k)},this.getDrawingBufferSize=function(T){return T.set(Xe*Ie,Oe*Ie).floor()},this.setDrawingBufferSize=function(T,k,q){Xe=T,Oe=k,Ie=q,t.width=Math.floor(T*q),t.height=Math.floor(k*q),this.setViewport(0,0,T,k)},this.setEffects=function(T){if(_===ti){Ve("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(T){for(let k=0;k<T.length;k++)if(T[k].isOutputPass===!0){ke("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}b.setEffects(T||[])},this.getCurrentViewport=function(T){return T.copy(Z)},this.getViewport=function(T){return T.copy(se)},this.setViewport=function(T,k,q,G){T.isVector4?se.set(T.x,T.y,T.z,T.w):se.set(T,k,q,G),pe.viewport(Z.copy(se).multiplyScalar(Ie).round())},this.getScissor=function(T){return T.copy(Ee)},this.setScissor=function(T,k,q,G){T.isVector4?Ee.set(T.x,T.y,T.z,T.w):Ee.set(T,k,q,G),pe.scissor(j.copy(Ee).multiplyScalar(Ie).round())},this.getScissorTest=function(){return Fe},this.setScissorTest=function(T){pe.setScissorTest(Fe=T)},this.setOpaqueSort=function(T){$=T},this.setTransparentSort=function(T){oe=T},this.getClearColor=function(T){return T.copy(le.getClearColor())},this.setClearColor=function(){le.setClearColor(...arguments)},this.getClearAlpha=function(){return le.getClearAlpha()},this.setClearAlpha=function(){le.setClearAlpha(...arguments)},this.clear=function(T=!0,k=!0,q=!0){let G=0;if(T){let H=!1;if(L!==null){let _e=L.texture.format;H=p.has(_e)}if(H){let _e=L.texture.type,ve=m.has(_e),Me=le.getClearColor(),Pe=le.getClearAlpha(),De=Me.r,Je=Me.g,et=Me.b;ve?(v[0]=De,v[1]=Je,v[2]=et,v[3]=Pe,F.clearBufferuiv(F.COLOR,0,v)):(S[0]=De,S[1]=Je,S[2]=et,S[3]=Pe,F.clearBufferiv(F.COLOR,0,S))}else G|=F.COLOR_BUFFER_BIT}k&&(G|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),q&&(G|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G!==0&&F.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(T){T.setRenderer(this),P=T},this.dispose=function(){t.removeEventListener("webglcontextlost",te,!1),t.removeEventListener("webglcontextrestored",re,!1),t.removeEventListener("webglcontextcreationerror",ue,!1),le.dispose(),Q.dispose(),ge.dispose(),C.dispose(),V.dispose(),he.dispose(),ae.dispose(),K.dispose(),ne.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",it),ce.removeEventListener("sessionend",Ct),Rt.stop()};function te(T){T.preventDefault(),Oh("WebGLRenderer: Context Lost."),I=!0}function re(){Oh("WebGLRenderer: Context Restored."),I=!1;let T=Ke.autoReset,k=fe.enabled,q=fe.autoUpdate,G=fe.needsUpdate,H=fe.type;xe(),Ke.autoReset=T,fe.enabled=k,fe.autoUpdate=q,fe.needsUpdate=G,fe.type=H}function ue(T){Ve("WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function Ne(T){let k=T.target;k.removeEventListener("dispose",Ne),ie(k)}function ie(T){Ue(T),C.remove(T)}function Ue(T){let k=C.get(T).programs;k!==void 0&&(k.forEach(function(q){ne.releaseProgram(q)}),T.isShaderMaterial&&ne.releaseShaderCache(T))}this.renderBufferDirect=function(T,k,q,G,H,_e){k===null&&(k=X);let ve=H.isMesh&&H.matrixWorld.determinant()<0,Me=nn(T,k,q,G,H);pe.setMaterial(G,ve);let Pe=q.index,De=1;if(G.wireframe===!0){if(Pe=ee.getWireframeAttribute(q),Pe===void 0)return;De=2}let Je=q.drawRange,et=q.attributes.position,Le=Je.start*De,xt=(Je.start+Je.count)*De;_e!==null&&(Le=Math.max(Le,_e.start*De),xt=Math.min(xt,(_e.start+_e.count)*De)),Pe!==null?(Le=Math.max(Le,0),xt=Math.min(xt,Pe.count)):et!=null&&(Le=Math.max(Le,0),xt=Math.min(xt,et.count));let Gt=xt-Le;if(Gt<0||Gt===1/0)return;ae.setup(H,G,Me,q,Pe);let Ut,yt=Ge;if(Pe!==null&&(Ut=J.get(Pe),yt=qe,yt.setIndex(Ut)),H.isMesh)G.wireframe===!0?(pe.setLineWidth(G.wireframeLinewidth*It()),yt.setMode(F.LINES)):yt.setMode(F.TRIANGLES);else if(H.isLine){let pn=G.linewidth;pn===void 0&&(pn=1),pe.setLineWidth(pn*It()),H.isLineSegments?yt.setMode(F.LINES):H.isLineLoop?yt.setMode(F.LINE_LOOP):yt.setMode(F.LINE_STRIP)}else H.isPoints?yt.setMode(F.POINTS):H.isSprite&&yt.setMode(F.TRIANGLES);if(H.isBatchedMesh)if(We.get("WEBGL_multi_draw"))yt.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{let pn=H._multiDrawStarts,we=H._multiDrawCounts,Yn=H._multiDrawCount,ht=Pe?J.get(Pe).bytesPerElement:1,hi=C.get(G).currentProgram.getUniforms();for(let Pi=0;Pi<Yn;Pi++)hi.setValue(F,"_gl_DrawID",Pi),yt.render(pn[Pi]/ht,we[Pi])}else if(H.isInstancedMesh)yt.renderInstances(Le,Gt,H.count);else if(q.isInstancedBufferGeometry){let pn=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,we=Math.min(q.instanceCount,pn);yt.renderInstances(Le,Gt,we)}else yt.render(Le,Gt)};function Re(T,k,q){T.transparent===!0&&T.side===di&&T.forceSinglePass===!1?(T.side=Pn,T.needsUpdate=!0,tn(T,k,q),T.side=tr,T.needsUpdate=!0,tn(T,k,q),T.side=di):tn(T,k,q)}this.compile=function(T,k,q=null){q===null&&(q=T),w=ge.get(q),w.init(k),x.push(w),q.traverseVisible(function(H){H.isLight&&H.layers.test(k.layers)&&(w.pushLight(H),H.castShadow&&w.pushShadow(H))}),T!==q&&T.traverseVisible(function(H){H.isLight&&H.layers.test(k.layers)&&(w.pushLight(H),H.castShadow&&w.pushShadow(H))}),w.setupLights();let G=new Set;return T.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;let _e=H.material;if(_e)if(Array.isArray(_e))for(let ve=0;ve<_e.length;ve++){let Me=_e[ve];Re(Me,q,H),G.add(Me)}else Re(_e,q,H),G.add(_e)}),w=x.pop(),G},this.compileAsync=function(T,k,q=null){let G=this.compile(T,k,q);return new Promise(H=>{function _e(){if(G.forEach(function(ve){C.get(ve).currentProgram.isReady()&&G.delete(ve)}),G.size===0){H(T);return}setTimeout(_e,10)}We.get("KHR_parallel_shader_compile")!==null?_e():setTimeout(_e,10)})};let He=null;function Xt(T){He&&He(T)}function it(){Rt.stop()}function Ct(){Rt.start()}let Rt=new um;Rt.setAnimationLoop(Xt),typeof self<"u"&&Rt.setContext(self),this.setAnimationLoop=function(T){He=T,ce.setAnimationLoop(T),T===null?Rt.stop():Rt.start()},ce.addEventListener("sessionstart",it),ce.addEventListener("sessionend",Ct),this.render=function(T,k){if(k!==void 0&&k.isCamera!==!0){Ve("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;P!==null&&P.renderStart(T,k);let q=ce.enabled===!0&&ce.isPresenting===!0,G=b!==null&&(L===null||q)&&b.begin(R,L);if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(b===null||b.isCompositing()===!1)&&(ce.cameraAutoUpdate===!0&&ce.updateCamera(k),k=ce.getCamera()),T.isScene===!0&&T.onBeforeRender(R,T,k,L),w=ge.get(T,x.length),w.init(k),w.state.textureUnits=y.getTextureUnits(),x.push(w),ze.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),Ce.setFromProjectionMatrix(ze,Ti,k.reversedDepth),Te=this.localClippingEnabled,je=Se.init(this.clippingPlanes,Te),A=Q.get(T,E.length),A.init(),E.push(A),ce.enabled===!0&&ce.isPresenting===!0){let ve=R.xr.getDepthSensingMesh();ve!==null&&Tt(ve,k,-1/0,R.sortObjects)}Tt(T,k,0,R.sortObjects),A.finish(),R.sortObjects===!0&&A.sort($,oe),at=ce.enabled===!1||ce.isPresenting===!1||ce.hasDepthSensing()===!1,at&&le.addToRenderList(A,T),this.info.render.frame++,je===!0&&Se.beginShadows();let H=w.state.shadowsArray;if(fe.render(H,T,k),je===!0&&Se.endShadows(),this.info.autoReset===!0&&this.info.reset(),(G&&b.hasRenderPass())===!1){let ve=A.opaque,Me=A.transmissive;if(w.setupLights(),k.isArrayCamera){let Pe=k.cameras;if(Me.length>0)for(let De=0,Je=Pe.length;De<Je;De++){let et=Pe[De];pt(ve,Me,T,et)}at&&le.render(T);for(let De=0,Je=Pe.length;De<Je;De++){let et=Pe[De];vt(A,T,et,et.viewport)}}else Me.length>0&&pt(ve,Me,T,k),at&&le.render(T),vt(A,T,k)}L!==null&&z===0&&(y.updateMultisampleRenderTarget(L),y.updateRenderTargetMipmap(L)),G&&b.end(R),T.isScene===!0&&T.onAfterRender(R,T,k),ae.resetDefaultState(),O=-1,U=null,x.pop(),x.length>0?(w=x[x.length-1],y.setTextureUnits(w.state.textureUnits),je===!0&&Se.setGlobalState(R.clippingPlanes,w.state.camera)):w=null,E.pop(),E.length>0?A=E[E.length-1]:A=null,P!==null&&P.renderEnd()};function Tt(T,k,q,G){if(T.visible===!1)return;if(T.layers.test(k.layers)){if(T.isGroup)q=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(k);else if(T.isLightProbeGrid)w.pushLightProbeGrid(T);else if(T.isLight)w.pushLight(T),T.castShadow&&w.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||Ce.intersectsSprite(T)){G&&Be.setFromMatrixPosition(T.matrixWorld).applyMatrix4(ze);let ve=he.update(T),Me=T.material;Me.visible&&A.push(T,ve,Me,q,Be.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||Ce.intersectsObject(T))){let ve=he.update(T),Me=T.material;if(G&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),Be.copy(T.boundingSphere.center)):(ve.boundingSphere===null&&ve.computeBoundingSphere(),Be.copy(ve.boundingSphere.center)),Be.applyMatrix4(T.matrixWorld).applyMatrix4(ze)),Array.isArray(Me)){let Pe=ve.groups;for(let De=0,Je=Pe.length;De<Je;De++){let et=Pe[De],Le=Me[et.materialIndex];Le&&Le.visible&&A.push(T,ve,Le,q,Be.z,et)}}else Me.visible&&A.push(T,ve,Me,q,Be.z,null)}}let _e=T.children;for(let ve=0,Me=_e.length;ve<Me;ve++)Tt(_e[ve],k,q,G)}function vt(T,k,q,G){let{opaque:H,transmissive:_e,transparent:ve}=T;w.setupLightsView(q),je===!0&&Se.setGlobalState(R.clippingPlanes,q),G&&pe.viewport(Z.copy(G)),H.length>0&&dn(H,k,q),_e.length>0&&dn(_e,k,q),ve.length>0&&dn(ve,k,q),pe.buffers.depth.setTest(!0),pe.buffers.depth.setMask(!0),pe.buffers.color.setMask(!0),pe.setPolygonOffset(!1)}function pt(T,k,q,G){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[G.id]===void 0){let Le=We.has("EXT_color_buffer_half_float")||We.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[G.id]=new $n(1,1,{generateMipmaps:!0,type:Le?ki:ti,minFilter:Lr,samples:Math.max(4,lt.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ot.workingColorSpace})}let _e=w.state.transmissionRenderTarget[G.id],ve=G.viewport||Z;_e.setSize(ve.z*R.transmissionResolutionScale,ve.w*R.transmissionResolutionScale);let Me=R.getRenderTarget(),Pe=R.getActiveCubeFace(),De=R.getActiveMipmapLevel();R.setRenderTarget(_e),R.getClearColor(de),be=R.getClearAlpha(),be<1&&R.setClearColor(16777215,.5),R.clear(),at&&le.render(q);let Je=R.toneMapping;R.toneMapping=wi;let et=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),w.setupLightsView(G),je===!0&&Se.setGlobalState(R.clippingPlanes,G),dn(T,q,G),y.updateMultisampleRenderTarget(_e),y.updateRenderTargetMipmap(_e),We.has("WEBGL_multisampled_render_to_texture")===!1){let Le=!1;for(let xt=0,Gt=k.length;xt<Gt;xt++){let Ut=k[xt],{object:yt,geometry:pn,material:we,group:Yn}=Ut;if(we.side===di&&yt.layers.test(G.layers)){let ht=we.side;we.side=Pn,we.needsUpdate=!0,wt(yt,q,G,pn,we,Yn),we.side=ht,we.needsUpdate=!0,Le=!0}}Le===!0&&(y.updateMultisampleRenderTarget(_e),y.updateRenderTargetMipmap(_e))}R.setRenderTarget(Me,Pe,De),R.setClearColor(de,be),et!==void 0&&(G.viewport=et),R.toneMapping=Je}function dn(T,k,q){let G=k.isScene===!0?k.overrideMaterial:null;for(let H=0,_e=T.length;H<_e;H++){let ve=T[H],{object:Me,geometry:Pe,group:De}=ve,Je=ve.material;Je.allowOverride===!0&&G!==null&&(Je=G),Me.layers.test(q.layers)&&wt(Me,k,q,Pe,Je,De)}}function wt(T,k,q,G,H,_e){T.onBeforeRender(R,k,q,G,H,_e),T.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),H.onBeforeRender(R,k,q,G,T,_e),H.transparent===!0&&H.side===di&&H.forceSinglePass===!1?(H.side=Pn,H.needsUpdate=!0,R.renderBufferDirect(q,k,G,H,T,_e),H.side=tr,H.needsUpdate=!0,R.renderBufferDirect(q,k,G,H,T,_e),H.side=di):R.renderBufferDirect(q,k,G,H,T,_e),T.onAfterRender(R,k,q,G,H,_e)}function tn(T,k,q){k.isScene!==!0&&(k=X);let G=C.get(T),H=w.state.lights,_e=w.state.shadowsArray,ve=H.state.version,Me=ne.getParameters(T,H.state,_e,k,q,w.state.lightProbeGridArray),Pe=ne.getProgramCacheKey(Me),De=G.programs;G.environment=T.isMeshStandardMaterial||T.isMeshLambertMaterial||T.isMeshPhongMaterial?k.environment:null,G.fog=k.fog;let Je=T.isMeshStandardMaterial||T.isMeshLambertMaterial&&!T.envMap||T.isMeshPhongMaterial&&!T.envMap;G.envMap=V.get(T.envMap||G.environment,Je),G.envMapRotation=G.environment!==null&&T.envMap===null?k.environmentRotation:T.envMapRotation,De===void 0&&(T.addEventListener("dispose",Ne),De=new Map,G.programs=De);let et=De.get(Pe);if(et!==void 0){if(G.currentProgram===et&&G.lightsStateVersion===ve)return qt(T,Me),et}else Me.uniforms=ne.getUniforms(T),P!==null&&T.isNodeMaterial&&P.build(T,q,Me),T.onBeforeCompile(Me,R),et=ne.acquireProgram(Me,Pe),De.set(Pe,et),G.uniforms=Me.uniforms;let Le=G.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Le.clippingPlanes=Se.uniform),qt(T,Me),G.needsLights=Rs(T),G.lightsStateVersion=ve,G.needsLights&&(Le.ambientLightColor.value=H.state.ambient,Le.lightProbe.value=H.state.probe,Le.directionalLights.value=H.state.directional,Le.directionalLightShadows.value=H.state.directionalShadow,Le.spotLights.value=H.state.spot,Le.spotLightShadows.value=H.state.spotShadow,Le.rectAreaLights.value=H.state.rectArea,Le.ltc_1.value=H.state.rectAreaLTC1,Le.ltc_2.value=H.state.rectAreaLTC2,Le.pointLights.value=H.state.point,Le.pointLightShadows.value=H.state.pointShadow,Le.hemisphereLights.value=H.state.hemi,Le.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Le.spotLightMatrix.value=H.state.spotLightMatrix,Le.spotLightMap.value=H.state.spotLightMap,Le.pointShadowMatrix.value=H.state.pointShadowMatrix),G.lightProbeGrid=w.state.lightProbeGridArray.length>0,G.currentProgram=et,G.uniformsList=null,et}function qn(T){if(T.uniformsList===null){let k=T.currentProgram.getUniforms();T.uniformsList=ra.seqWithValue(k.seq,T.uniforms)}return T.uniformsList}function qt(T,k){let q=C.get(T);q.outputColorSpace=k.outputColorSpace,q.batching=k.batching,q.batchingColor=k.batchingColor,q.instancing=k.instancing,q.instancingColor=k.instancingColor,q.instancingMorph=k.instancingMorph,q.skinning=k.skinning,q.morphTargets=k.morphTargets,q.morphNormals=k.morphNormals,q.morphColors=k.morphColors,q.morphTargetsCount=k.morphTargetsCount,q.numClippingPlanes=k.numClippingPlanes,q.numIntersection=k.numClipIntersection,q.vertexAlphas=k.vertexAlphas,q.vertexTangents=k.vertexTangents,q.toneMapping=k.toneMapping}function Kt(T,k){if(T.length===0)return null;if(T.length===1)return T[0].texture!==null?T[0]:null;M.setFromMatrixPosition(k.matrixWorld);for(let q=0,G=T.length;q<G;q++){let H=T[q];if(H.texture!==null&&H.boundingBox.containsPoint(M))return H}return null}function nn(T,k,q,G,H){k.isScene!==!0&&(k=X),y.resetTextureUnits();let _e=k.fog,ve=G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial?k.environment:null,Me=L===null?R.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:ot.workingColorSpace,Pe=G.isMeshStandardMaterial||G.isMeshLambertMaterial&&!G.envMap||G.isMeshPhongMaterial&&!G.envMap,De=V.get(G.envMap||ve,Pe),Je=G.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,et=!!q.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Le=!!q.morphAttributes.position,xt=!!q.morphAttributes.normal,Gt=!!q.morphAttributes.color,Ut=wi;G.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(Ut=R.toneMapping);let yt=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,pn=yt!==void 0?yt.length:0,we=C.get(G),Yn=w.state.lights;if(je===!0&&(Te===!0||T!==U)){let Et=T===U&&G.id===O;Se.setState(G,T,Et)}let ht=!1;G.version===we.__version?(we.needsLights&&we.lightsStateVersion!==Yn.state.version||we.outputColorSpace!==Me||H.isBatchedMesh&&we.batching===!1||!H.isBatchedMesh&&we.batching===!0||H.isBatchedMesh&&we.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&we.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&we.instancing===!1||!H.isInstancedMesh&&we.instancing===!0||H.isSkinnedMesh&&we.skinning===!1||!H.isSkinnedMesh&&we.skinning===!0||H.isInstancedMesh&&we.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&we.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&we.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&we.instancingMorph===!1&&H.morphTexture!==null||we.envMap!==De||G.fog===!0&&we.fog!==_e||we.numClippingPlanes!==void 0&&(we.numClippingPlanes!==Se.numPlanes||we.numIntersection!==Se.numIntersection)||we.vertexAlphas!==Je||we.vertexTangents!==et||we.morphTargets!==Le||we.morphNormals!==xt||we.morphColors!==Gt||we.toneMapping!==Ut||we.morphTargetsCount!==pn||!!we.lightProbeGrid!=w.state.lightProbeGridArray.length>0)&&(ht=!0):(ht=!0,we.__version=G.version);let hi=we.currentProgram;ht===!0&&(hi=tn(G,k,H),P&&G.isNodeMaterial&&P.onUpdateProgram(G,hi,we));let Pi=!1,pr=!1,Ps=!1,Mt=hi.getUniforms(),Ht=we.uniforms;if(pe.useProgram(hi.program)&&(Pi=!0,pr=!0,Ps=!0),G.id!==O&&(O=G.id,pr=!0),we.needsLights){let Et=Kt(w.state.lightProbeGridArray,H);we.lightProbeGrid!==Et&&(we.lightProbeGrid=Et,pr=!0)}if(Pi||U!==T){pe.buffers.depth.getReversed()&&T.reversedDepth!==!0&&(T._reversedDepth=!0,T.updateProjectionMatrix()),Mt.setValue(F,"projectionMatrix",T.projectionMatrix),Mt.setValue(F,"viewMatrix",T.matrixWorldInverse);let gr=Mt.map.cameraPosition;gr!==void 0&&gr.setValue(F,$e.setFromMatrixPosition(T.matrixWorld)),lt.logarithmicDepthBuffer&&Mt.setValue(F,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&Mt.setValue(F,"isOrthographic",T.isOrthographicCamera===!0),U!==T&&(U=T,pr=!0,Ps=!0)}if(we.needsLights&&(Yn.state.directionalShadowMap.length>0&&Mt.setValue(F,"directionalShadowMap",Yn.state.directionalShadowMap,y),Yn.state.spotShadowMap.length>0&&Mt.setValue(F,"spotShadowMap",Yn.state.spotShadowMap,y),Yn.state.pointShadowMap.length>0&&Mt.setValue(F,"pointShadowMap",Yn.state.pointShadowMap,y)),H.isSkinnedMesh){Mt.setOptional(F,H,"bindMatrix"),Mt.setOptional(F,H,"bindMatrixInverse");let Et=H.skeleton;Et&&(Et.boneTexture===null&&Et.computeBoneTexture(),Mt.setValue(F,"boneTexture",Et.boneTexture,y))}H.isBatchedMesh&&(Mt.setOptional(F,H,"batchingTexture"),Mt.setValue(F,"batchingTexture",H._matricesTexture,y),Mt.setOptional(F,H,"batchingIdTexture"),Mt.setValue(F,"batchingIdTexture",H._indirectTexture,y),Mt.setOptional(F,H,"batchingColorTexture"),H._colorsTexture!==null&&Mt.setValue(F,"batchingColorTexture",H._colorsTexture,y));let mr=q.morphAttributes;if((mr.position!==void 0||mr.normal!==void 0||mr.color!==void 0)&&me.update(H,q,hi),(pr||we.receiveShadow!==H.receiveShadow)&&(we.receiveShadow=H.receiveShadow,Mt.setValue(F,"receiveShadow",H.receiveShadow)),(G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial)&&G.envMap===null&&k.environment!==null&&(Ht.envMapIntensity.value=k.environmentIntensity),Ht.dfgLUT!==void 0&&(Ht.dfgLUT.value=aS()),pr){if(Mt.setValue(F,"toneMappingExposure",R.toneMappingExposure),we.needsLights&&Zi(Ht,Ps),_e&&G.fog===!0&&Y.refreshFogUniforms(Ht,_e),Y.refreshMaterialUniforms(Ht,G,Ie,Oe,w.state.transmissionRenderTarget[T.id]),we.needsLights&&we.lightProbeGrid){let Et=we.lightProbeGrid;Ht.probesSH.value=Et.texture,Ht.probesMin.value.copy(Et.boundingBox.min),Ht.probesMax.value.copy(Et.boundingBox.max),Ht.probesResolution.value.copy(Et.resolution)}ra.upload(F,qn(we),Ht,y)}if(G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(ra.upload(F,qn(we),Ht,y),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&Mt.setValue(F,"center",H.center),Mt.setValue(F,"modelViewMatrix",H.modelViewMatrix),Mt.setValue(F,"normalMatrix",H.normalMatrix),Mt.setValue(F,"modelMatrix",H.matrixWorld),G.uniformsGroups!==void 0){let Et=G.uniformsGroups;for(let gr=0,Is=Et.length;gr<Is;gr++){let Id=Et[gr];K.update(Id,hi),K.bind(Id,hi)}}return hi}function Zi(T,k){T.ambientLightColor.needsUpdate=k,T.lightProbe.needsUpdate=k,T.directionalLights.needsUpdate=k,T.directionalLightShadows.needsUpdate=k,T.pointLights.needsUpdate=k,T.pointLightShadows.needsUpdate=k,T.spotLights.needsUpdate=k,T.spotLightShadows.needsUpdate=k,T.rectAreaLights.needsUpdate=k,T.hemisphereLights.needsUpdate=k}function Rs(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(T,k,q){let G=C.get(T);G.__autoAllocateDepthBuffer=T.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),C.get(T.texture).__webglTexture=k,C.get(T.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:q,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(T,k){let q=C.get(T);q.__webglFramebuffer=k,q.__useDefaultFramebuffer=k===void 0};let rn=F.createFramebuffer();this.setRenderTarget=function(T,k=0,q=0){L=T,B=k,z=q;let G=null,H=!1,_e=!1;if(T){let Me=C.get(T);if(Me.__useDefaultFramebuffer!==void 0){pe.bindFramebuffer(F.FRAMEBUFFER,Me.__webglFramebuffer),Z.copy(T.viewport),j.copy(T.scissor),D=T.scissorTest,pe.viewport(Z),pe.scissor(j),pe.setScissorTest(D),O=-1;return}else if(Me.__webglFramebuffer===void 0)y.setupRenderTarget(T);else if(Me.__hasExternalTextures)y.rebindTextures(T,C.get(T.texture).__webglTexture,C.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){let Je=T.depthTexture;if(Me.__boundDepthTexture!==Je){if(Je!==null&&C.has(Je)&&(T.width!==Je.image.width||T.height!==Je.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");y.setupDepthRenderbuffer(T)}}let Pe=T.texture;(Pe.isData3DTexture||Pe.isDataArrayTexture||Pe.isCompressedArrayTexture)&&(_e=!0);let De=C.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(De[k])?G=De[k][q]:G=De[k],H=!0):T.samples>0&&y.useMultisampledRTT(T)===!1?G=C.get(T).__webglMultisampledFramebuffer:Array.isArray(De)?G=De[q]:G=De,Z.copy(T.viewport),j.copy(T.scissor),D=T.scissorTest}else Z.copy(se).multiplyScalar(Ie).floor(),j.copy(Ee).multiplyScalar(Ie).floor(),D=Fe;if(q!==0&&(G=rn),pe.bindFramebuffer(F.FRAMEBUFFER,G)&&pe.drawBuffers(T,G),pe.viewport(Z),pe.scissor(j),pe.setScissorTest(D),H){let Me=C.get(T.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+k,Me.__webglTexture,q)}else if(_e){let Me=k;for(let Pe=0;Pe<T.textures.length;Pe++){let De=C.get(T.textures[Pe]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+Pe,De.__webglTexture,q,Me)}}else if(T!==null&&q!==0){let Me=C.get(T.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Me.__webglTexture,q)}O=-1},this.readRenderTargetPixels=function(T,k,q,G,H,_e,ve,Me=0){if(!(T&&T.isWebGLRenderTarget)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=C.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ve!==void 0&&(Pe=Pe[ve]),Pe){pe.bindFramebuffer(F.FRAMEBUFFER,Pe);try{let De=T.textures[Me],Je=De.format,et=De.type;if(T.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+Me),!lt.textureFormatReadable(Je)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!lt.textureTypeReadable(et)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=T.width-G&&q>=0&&q<=T.height-H&&F.readPixels(k,q,G,H,N.convert(Je),N.convert(et),_e)}finally{let De=L!==null?C.get(L).__webglFramebuffer:null;pe.bindFramebuffer(F.FRAMEBUFFER,De)}}},this.readRenderTargetPixelsAsync=async function(T,k,q,G,H,_e,ve,Me=0){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pe=C.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ve!==void 0&&(Pe=Pe[ve]),Pe)if(k>=0&&k<=T.width-G&&q>=0&&q<=T.height-H){pe.bindFramebuffer(F.FRAMEBUFFER,Pe);let De=T.textures[Me],Je=De.format,et=De.type;if(T.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+Me),!lt.textureFormatReadable(Je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!lt.textureTypeReadable(et))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Le=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,Le),F.bufferData(F.PIXEL_PACK_BUFFER,_e.byteLength,F.STREAM_READ),F.readPixels(k,q,G,H,N.convert(Je),N.convert(et),0);let xt=L!==null?C.get(L).__webglFramebuffer:null;pe.bindFramebuffer(F.FRAMEBUFFER,xt);let Gt=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await Op(F,Gt,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,Le),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,_e),F.deleteBuffer(Le),F.deleteSync(Gt),_e}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(T,k=null,q=0){let G=Math.pow(2,-q),H=Math.floor(T.image.width*G),_e=Math.floor(T.image.height*G),ve=k!==null?k.x:0,Me=k!==null?k.y:0;y.setTexture2D(T,0),F.copyTexSubImage2D(F.TEXTURE_2D,q,0,0,ve,Me,H,_e),pe.unbindTexture()};let Vt=F.createFramebuffer(),ui=F.createFramebuffer();this.copyTextureToTexture=function(T,k,q=null,G=null,H=0,_e=0){let ve,Me,Pe,De,Je,et,Le,xt,Gt,Ut=T.isCompressedTexture?T.mipmaps[_e]:T.image;if(q!==null)ve=q.max.x-q.min.x,Me=q.max.y-q.min.y,Pe=q.isBox3?q.max.z-q.min.z:1,De=q.min.x,Je=q.min.y,et=q.isBox3?q.min.z:0;else{let Ht=Math.pow(2,-H);ve=Math.floor(Ut.width*Ht),Me=Math.floor(Ut.height*Ht),T.isDataArrayTexture?Pe=Ut.depth:T.isData3DTexture?Pe=Math.floor(Ut.depth*Ht):Pe=1,De=0,Je=0,et=0}G!==null?(Le=G.x,xt=G.y,Gt=G.z):(Le=0,xt=0,Gt=0);let yt=N.convert(k.format),pn=N.convert(k.type),we;k.isData3DTexture?(y.setTexture3D(k,0),we=F.TEXTURE_3D):k.isDataArrayTexture||k.isCompressedArrayTexture?(y.setTexture2DArray(k,0),we=F.TEXTURE_2D_ARRAY):(y.setTexture2D(k,0),we=F.TEXTURE_2D),pe.activeTexture(F.TEXTURE0),pe.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,k.flipY),pe.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),pe.pixelStorei(F.UNPACK_ALIGNMENT,k.unpackAlignment);let Yn=pe.getParameter(F.UNPACK_ROW_LENGTH),ht=pe.getParameter(F.UNPACK_IMAGE_HEIGHT),hi=pe.getParameter(F.UNPACK_SKIP_PIXELS),Pi=pe.getParameter(F.UNPACK_SKIP_ROWS),pr=pe.getParameter(F.UNPACK_SKIP_IMAGES);pe.pixelStorei(F.UNPACK_ROW_LENGTH,Ut.width),pe.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ut.height),pe.pixelStorei(F.UNPACK_SKIP_PIXELS,De),pe.pixelStorei(F.UNPACK_SKIP_ROWS,Je),pe.pixelStorei(F.UNPACK_SKIP_IMAGES,et);let Ps=T.isDataArrayTexture||T.isData3DTexture,Mt=k.isDataArrayTexture||k.isData3DTexture;if(T.isDepthTexture){let Ht=C.get(T),mr=C.get(k),Et=C.get(Ht.__renderTarget),gr=C.get(mr.__renderTarget);pe.bindFramebuffer(F.READ_FRAMEBUFFER,Et.__webglFramebuffer),pe.bindFramebuffer(F.DRAW_FRAMEBUFFER,gr.__webglFramebuffer);for(let Is=0;Is<Pe;Is++)Ps&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,C.get(T).__webglTexture,H,et+Is),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,C.get(k).__webglTexture,_e,Gt+Is)),F.blitFramebuffer(De,Je,ve,Me,Le,xt,ve,Me,F.DEPTH_BUFFER_BIT,F.NEAREST);pe.bindFramebuffer(F.READ_FRAMEBUFFER,null),pe.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(H!==0||T.isRenderTargetTexture||C.has(T)){let Ht=C.get(T),mr=C.get(k);pe.bindFramebuffer(F.READ_FRAMEBUFFER,Vt),pe.bindFramebuffer(F.DRAW_FRAMEBUFFER,ui);for(let Et=0;Et<Pe;Et++)Ps?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ht.__webglTexture,H,et+Et):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Ht.__webglTexture,H),Mt?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,mr.__webglTexture,_e,Gt+Et):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,mr.__webglTexture,_e),H!==0?F.blitFramebuffer(De,Je,ve,Me,Le,xt,ve,Me,F.COLOR_BUFFER_BIT,F.NEAREST):Mt?F.copyTexSubImage3D(we,_e,Le,xt,Gt+Et,De,Je,ve,Me):F.copyTexSubImage2D(we,_e,Le,xt,De,Je,ve,Me);pe.bindFramebuffer(F.READ_FRAMEBUFFER,null),pe.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else Mt?T.isDataTexture||T.isData3DTexture?F.texSubImage3D(we,_e,Le,xt,Gt,ve,Me,Pe,yt,pn,Ut.data):k.isCompressedArrayTexture?F.compressedTexSubImage3D(we,_e,Le,xt,Gt,ve,Me,Pe,yt,Ut.data):F.texSubImage3D(we,_e,Le,xt,Gt,ve,Me,Pe,yt,pn,Ut):T.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,_e,Le,xt,ve,Me,yt,pn,Ut.data):T.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,_e,Le,xt,Ut.width,Ut.height,yt,Ut.data):F.texSubImage2D(F.TEXTURE_2D,_e,Le,xt,ve,Me,yt,pn,Ut);pe.pixelStorei(F.UNPACK_ROW_LENGTH,Yn),pe.pixelStorei(F.UNPACK_IMAGE_HEIGHT,ht),pe.pixelStorei(F.UNPACK_SKIP_PIXELS,hi),pe.pixelStorei(F.UNPACK_SKIP_ROWS,Pi),pe.pixelStorei(F.UNPACK_SKIP_IMAGES,pr),_e===0&&k.generateMipmaps&&F.generateMipmap(we),pe.unbindTexture()},this.initRenderTarget=function(T){C.get(T).__webglFramebuffer===void 0&&y.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?y.setTextureCube(T,0):T.isData3DTexture?y.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?y.setTexture2DArray(T,0):y.setTexture2D(T,0),pe.unbindTexture()},this.resetState=function(){B=0,z=0,L=null,pe.reset(),ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ti}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=ot._getDrawingBufferColorSpace(e),t.unpackColorSpace=ot._getUnpackColorSpace()}}});function Tm(){if(xm)return;let r=document.getElementById("space-canvas");if(!r)return;xm=!0,po=new Gc({canvas:r,alpha:!0,antialias:!0}),po.setSize(window.innerWidth,window.innerHeight),po.setPixelRatio(window.devicePixelRatio),aa=new Va;let e=new _n(75,window.innerWidth/window.innerHeight,.1,1e3);e.position.z=400,uf=new zn;let t=4e3,n=new Float32Array(t*3);for(let p=0;p<t*3;p++)n[p]=(Math.random()-.5)*1500;uf.setAttribute("position",new En(n,3));let i=()=>{let p=document.createElement("canvas");p.width=16,p.height=16;let m=p.getContext("2d");if(m){let v=m.createRadialGradient(8,8,0,8,8,8);v.addColorStop(0,"rgba(255,255,255,1)"),v.addColorStop(.2,"rgba(210,230,255,0.8)"),v.addColorStop(.5,"rgba(100,150,255,0.2)"),v.addColorStop(1,"rgba(0,0,0,0)"),m.fillStyle=v,m.fillRect(0,0,16,16)}return new $s(p)};hf=new Ks({size:2,map:i(),transparent:!0,opacity:.9,color:16777215,blending:ea,depthWrite:!1}),Xc=new Xa(uf,hf),aa.add(Xc),vm=new Za(.8,0,150,8),ym=new Cr({color:16777215,transparent:!0,opacity:.9,blending:ea,depthWrite:!1}),Or=new Rn(vm,ym),aa.add(Or);let s=new W(-10,-5,-8),a=s.clone().normalize();Or.quaternion.setFromUnitVectors(new W(0,1,0),a);let o=()=>{Or.position.set(Math.random()*1e3+800,Math.random()*800+500,(Math.random()-.5)*1e3)};o(),[{name:"Python",color:"#3776AB"},{name:"Rust",color:"#DEA584"},{name:"Go",color:"#00ADD8"},{name:"FastAPI",color:"#009688"}].forEach((p,m)=>{let v=document.createElement("canvas");v.width=256,v.height=256;let S=v.getContext("2d");S&&(S.fillStyle=p.color,S.beginPath(),S.arc(128,128,120,0,Math.PI*2),S.fill(),S.fillStyle="white",S.font="bold 40px Inter, sans-serif",S.textAlign="center",S.textBaseline="middle",S.fillText(p.name,128,128));let M=new $s(v),A=new ss(30,30),w=new Cr({map:M,transparent:!0,opacity:.8,side:di,depthWrite:!1}),E=new Rn(A,w);E.position.set((Math.random()-.5)*400,(Math.random()-.5)*400,(Math.random()-.5)*200-100),aa.add(E),qc.push(E)});let c=0,u=0,d=new Qa,h=new ft;Mm=p=>{c=p.clientX/window.innerWidth-.5,u=p.clientY/window.innerHeight-.5},document.addEventListener("mousemove",Mm);let f=new ja,g=new Uint8Array(128),_=()=>{let p=f.getElapsedTime(),m=1;if(window.getAudioAnalyser){let S=window.getAudioAnalyser();if(S){S.getByteFrequencyData(g);let M=0;for(let w=0;w<g.length;w++)M+=g[w];m=1+M/g.length/256*1.5}}hf.size=2*m,Or.scale.set(m,m,m),Xc.rotation.y=p*.005,Xc.rotation.x=p*.002,Or.position.add(s),(Or.position.x<-1500||Or.position.y<-1e3)&&Math.random()<.02&&o(),e.position.x+=(c*50-e.position.x)*.05,e.position.y+=(-u*50-e.position.y)*.05,e.lookAt(aa.position),d.setFromCamera(h,e);let v=d.intersectObjects(qc);if(qc.forEach((S,M)=>{S.position.y+=Math.sin(p*2+M)*.2,S.rotation.y=Math.sin(p*.5+M)*.5,S.material.opacity=.6}),v.length>0){let S=v[0].object;S.material.opacity=1,S.scale.set(1.2,1.2,1.2),document.body.style.cursor="pointer"}else qc.forEach(S=>S.scale.set(1,1,1)),document.body.style.cursor="default";po.render(aa,e),lS=window.requestAnimationFrame(_)};if(Sm=p=>{h.x=p.clientX/window.innerWidth*2-1,h.y=-(p.clientY/window.innerHeight)*2+1},document.addEventListener("mousemove",Sm),_(),bm=()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),po.setSize(window.innerWidth,window.innerHeight)},window.addEventListener("resize",bm),window.gsap&&window.ScrollTrigger){let p=window.gsap;p.registerPlugin(window.ScrollTrigger),p.to(e.position,{z:50,ease:"none",scrollTrigger:{trigger:"body",start:"top top",end:"bottom bottom",scrub:1.5}})}}var xm,lS,aa,po,uf,hf,Xc,vm,ym,Or,qc,Mm,Sm,bm,wm=Ii(()=>{_m();xm=!1,lS=0,qc=[],Mm=null,Sm=null,bm=null});function Am(){let r=!1,e=async()=>{try{let n=await(await fetch("https://analytics-api.rashidkhanapdev.workers.dev/api/status")).json();n.status==="defcon1"&&!r?(r=!0,Em("DEFCON 1: SYSTEM SEIZED","UNAUTHORIZED ACCESS PROTOCOL ENGAGED"),localStorage.clear(),sessionStorage.clear(),fetch("https://analytics-api.rashidkhanapdev.workers.dev/api/track",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"blocked"})})):n.status==="maintenance"&&!r?(r=!0,Em("SYSTEM MAINTENANCE","We are currently upgrading our systems. Please check back later.")):n.status==="online"&&r&&(r=!1,window.location.reload())}catch{}};e(),setInterval(e,5e3)}function Em(r,e){document.body.innerHTML="",document.body.style.backgroundColor="#000",document.body.style.color="#ff0000",document.body.style.display="flex",document.body.style.flexDirection="column",document.body.style.justifyContent="center",document.body.style.alignItems="center",document.body.style.height="100vh",document.body.style.margin="0",document.body.style.overflow="hidden",document.body.style.fontFamily="'JetBrains Mono', monospace";let t=document.createElement("div");t.className="defcon-siren",document.body.appendChild(t);let n=document.createElement("div");n.style.textAlign="center",n.style.zIndex="1000",n.style.padding="3rem",n.style.background="rgba(25, 0, 0, 0.8)",n.style.border="2px solid #ff0000",n.style.boxShadow="0 0 50px rgba(255, 0, 0, 0.5)",n.style.backdropFilter="blur(10px)";let i=document.createElement("h1");i.textContent=r,i.style.fontSize="3rem",i.style.margin="0 0 1rem 0",i.style.textShadow="0 0 20px #ff0000";let s=document.createElement("p");s.textContent=e,s.style.fontSize="1.2rem",s.style.color="#ff8888",n.appendChild(i),n.appendChild(s),document.body.appendChild(n)}var Cm=Ii(()=>{});function cS(r){let e="";for(let t=0;t<r;t++)e+=Rm[Math.floor(Math.random()*Rm.length)];return e}function Pm(){let r=document.getElementById("btnAddStep"),e=document.getElementById("btnRandom"),t=document.getElementById("btnGenerate"),n=document.getElementById("bookmarksContainer"),i=document.getElementById("outputArea");!r||!n||!t||(r.addEventListener("click",()=>{let s=document.createElement("div");s.className="input-group fade-in",s.innerHTML=`
