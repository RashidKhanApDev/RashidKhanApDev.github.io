...
`)+`
`+m);let S=v+p+a,M=v+m+o,A=jp(i,i.VERTEX_SHADER,S),b=jp(i,i.FRAGMENT_SHADER,M);i.attachShader(_,A),i.attachShader(_,b),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(P){if(r.debug.checkShaderErrors){let I=i.getProgramInfoLog(_)||"",B=i.getShaderInfoLog(A)||"",z=i.getShaderInfoLog(b)||"",L=I.trim(),O=B.trim(),F=z.trim(),Z=!0,j=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,A,b);else{let D=tm(i,A,"vertex"),de=tm(i,b,"fragment");Ve("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`,lf=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Ya(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new jn({vertexShader:eS,fragmentShader:tS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Rn(new ss(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},cf=class extends Fi{constructor(e,t){super();let n=this,i=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,d=null,h=null,f=null,g=null,_=typeof XRWebGLBinding<"u",p=new lf,m={},v=t.getContextAttributes(),S=null,M=null,A=[],b=[],T=new ft,x=null,E=new _n;E.viewport=new Ot;let C=new _n;C.viewport=new Ot;let P=[E,C],I=new Jl,B=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let oe=A[$];return oe===void 0&&(oe=new Zs,A[$]=oe),oe.getTargetRaySpace()},this.getControllerGrip=function($){let oe=A[$];return oe===void 0&&(oe=new Zs,A[$]=oe),oe.getGripSpace()},this.getHand=function($){let oe=A[$];return oe===void 0&&(oe=new Zs,A[$]=oe),oe.getHandSpace()};function L($){let oe=b.indexOf($.inputSource);if(oe===-1)return;let se=A[oe];se!==void 0&&(se.update($.inputSource,$.frame,c||a),se.dispatchEvent({type:$.type,data:$.inputSource}))}function O(){i.removeEventListener("select",L),i.removeEventListener("selectstart",L),i.removeEventListener("selectend",L),i.removeEventListener("squeeze",L),i.removeEventListener("squeezestart",L),i.removeEventListener("squeezeend",L),i.removeEventListener("end",O),i.removeEventListener("inputsourceschange",F);for(let $=0;$<A.length;$++){let oe=b[$];oe!==null&&(b[$]=null,A[$].disconnect(oe))}B=null,z=null,p.reset();for(let $ in m)delete m[$];e.setRenderTarget(S),f=null,h=null,d=null,i=null,M=null,Ie.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(T.width,T.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){s=$,n.isPresenting===!0&&ke("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){o=$,n.isPresenting===!0&&ke("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function($){c=$},this.getBaseLayer=function(){return h!==null?h:f},this.getBinding=function(){return d===null&&_&&(d=new XRWebGLBinding(i,t)),d},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function($){if(i=$,i!==null){if(S=e.getRenderTarget(),i.addEventListener("select",L),i.addEventListener("selectstart",L),i.addEventListener("selectend",L),i.addEventListener("squeeze",L),i.addEventListener("squeezestart",L),i.addEventListener("squeezeend",L),i.addEventListener("end",O),i.addEventListener("inputsourceschange",F),v.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(T),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let se=null,Ee=null,Fe=null;v.depth&&(Fe=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,se=v.stencil?Nr:Ui,Ee=v.stencil?na:Ei);let Ce={colorFormat:t.RGBA8,depthFormat:Fe,scaleFactor:s};d=this.getBinding(),h=d.createProjectionLayer(Ce),i.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),M=new $n(h.textureWidth,h.textureHeight,{format:pi,type:ti,depthTexture:new nr(h.textureWidth,h.textureHeight,Ee,void 0,void 0,void 0,void 0,void 0,void 0,se),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{let se={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};f=new XRWebGLLayer(i,t,se),i.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new $n(f.framebufferWidth,f.framebufferHeight,{format:pi,type:ti,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await i.requestReferenceSpace(o),Ie.setContext(i),Ie.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function F($){for(let oe=0;oe<$.removed.length;oe++){let se=$.removed[oe],Ee=b.indexOf(se);Ee>=0&&(b[Ee]=null,A[Ee].disconnect(se))}for(let oe=0;oe<$.added.length;oe++){let se=$.added[oe],Ee=b.indexOf(se);if(Ee===-1){for(let Ce=0;Ce<A.length;Ce++)if(Ce>=b.length){b.push(se),Ee=Ce;break}else if(b[Ce]===null){b[Ce]=se,Ee=Ce;break}if(Ee===-1)break}let Fe=A[Ee];Fe&&Fe.connect(se)}}let Z=new W,j=new W;function D($,oe,se){Z.setFromMatrixPosition(oe.matrixWorld),j.setFromMatrixPosition(se.matrixWorld);let Ee=Z.distanceTo(j),Fe=oe.projectionMatrix.elements,Ce=se.projectionMatrix.elements,je=Fe[14]/(Fe[10]-1),Te=Fe[14]/(Fe[10]+1),ze=(Fe[9]+1)/Fe[5],$e=(Fe[9]-1)/Fe[5],Be=(Fe[8]-1)/Fe[0],X=(Ce[8]+1)/Ce[0],at=je*Be,It=je*X,U=Ee/(-Be+X),Ze=U*-Be;if(oe.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Ze),$.translateZ(U),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Fe[10]===-1)$.projectionMatrix.copy(oe.projectionMatrix),$.projectionMatrixInverse.copy(oe.projectionMatrixInverse);else{let We=je+U,lt=Te+U,pe=at-Ze,Ke=It+(Ee-Ze),R=ze*Te/lt*We,y=$e*Te/lt*We;$.projectionMatrix.makePerspective(pe,Ke,R,y,We,lt),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function de($,oe){oe===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(oe.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(i===null)return;let oe=$.near,se=$.far;p.texture!==null&&(p.depthNear>0&&(oe=p.depthNear),p.depthFar>0&&(se=p.depthFar)),I.near=C.near=E.near=oe,I.far=C.far=E.far=se,(B!==I.near||z!==I.far)&&(i.updateRenderState({depthNear:I.near,depthFar:I.far}),B=I.near,z=I.far),I.layers.mask=$.layers.mask|6,E.layers.mask=I.layers.mask&-5,C.layers.mask=I.layers.mask&-3;let Ee=$.parent,Fe=I.cameras;de(I,Ee);for(let Ce=0;Ce<Fe.length;Ce++)de(Fe[Ce],Ee);Fe.length===2?D(I,E,C):I.projectionMatrix.copy(E.projectionMatrix),be($,I,Ee)};function be($,oe,se){se===null?$.matrix.copy(oe.matrixWorld):($.matrix.copy(se.matrixWorld),$.matrix.invert(),$.matrix.multiply(oe.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(oe.projectionMatrix),$.projectionMatrixInverse.copy(oe.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=Rl*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return I},this.getFoveation=function(){if(!(h===null&&f===null))return l},this.setFoveation=function($){l=$,h!==null&&(h.fixedFoveation=$),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=$)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(I)},this.getCameraTexture=function($){return m[$]};let Xe=null;function Oe($,oe){if(u=oe.getViewerPose(c||a),g=oe,u!==null){let se=u.views;f!==null&&(e.setRenderTargetFramebuffer(M,f.framebuffer),e.setRenderTarget(M));let Ee=!1;se.length!==I.cameras.length&&(I.cameras.length=0,Ee=!0);for(let Te=0;Te<se.length;Te++){let ze=se[Te],$e=null;if(f!==null)$e=f.getViewport(ze);else{let X=d.getViewSubImage(h,ze);$e=X.viewport,Te===0&&(e.setRenderTargetTextures(M,X.colorTexture,X.depthStencilTexture),e.setRenderTarget(M))}let Be=P[Te];Be===void 0&&(Be=new _n,Be.layers.enable(Te),Be.viewport=new Ot,P[Te]=Be),Be.matrix.fromArray(ze.transform.matrix),Be.matrix.decompose(Be.position,Be.quaternion,Be.scale),Be.projectionMatrix.fromArray(ze.projectionMatrix),Be.projectionMatrixInverse.copy(Be.projectionMatrix).invert(),Be.viewport.set($e.x,$e.y,$e.width,$e.height),Te===0&&(I.matrix.copy(Be.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale)),Ee===!0&&I.cameras.push(Be)}let Fe=i.enabledFeatures;if(Fe&&Fe.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&_){d=n.getBinding();let Te=d.getDepthInformation(se[0]);Te&&Te.isValid&&Te.texture&&p.init(Te,i.renderState)}if(Fe&&Fe.includes("camera-access")&&_){e.state.unbindTexture(),d=n.getBinding();for(let Te=0;Te<se.length;Te++){let ze=se[Te].camera;if(ze){let $e=m[ze];$e||($e=new Ya,m[ze]=$e);let Be=d.getCameraImage(ze);$e.sourceTexture=Be}}}}for(let se=0;se<A.length;se++){let Ee=b[se],Fe=A[se];Ee!==null&&Fe!==void 0&&Fe.update(Ee,oe,c||a)}Xe&&Xe($,oe),oe.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:oe}),g=null}let Ie=new um;Ie.setAnimationLoop(Oe),this.setAnimationLoop=function($){Xe=$},this.dispose=function(){}}},nS=new Ft,gm=new Ye;gm.set(-1,0,0,0,1,0,0,0,1);sS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),zi=null;Gc=class{constructor(e={}){let{canvas:t=Up(),context:n=null,depth:i=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1,outputBufferType:f=ti}=e;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;let _=f,p=new Set([sc,rc,ic]),m=new Set([ti,Ei,ta,na,tc,nc]),v=new Uint32Array(4),S=new Int32Array(4),M=new W,A=null,b=null,T=[],x=[],E=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=wi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let C=this,P=!1,I=null;this._outputColorSpace=Kn;let B=0,z=0,L=null,O=-1,F=null,Z=new Ot,j=new Ot,D=null,de=new dt(0),be=0,Xe=t.width,Oe=t.height,Ie=1,$=null,oe=null,se=new Ot(0,0,Xe,Oe),Ee=new Ot(0,0,Xe,Oe),Fe=!1,Ce=new Wa,je=!1,Te=!1,ze=new Ft,$e=new W,Be=new Ot,X={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},at=!1;function It(){return L===null?Ie:1}let U=n;function Ze(w,k){return t.getContext(w,k)}try{let w={alpha:!0,depth:i,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"184"}`),t.addEventListener("webglcontextlost",te,!1),t.addEventListener("webglcontextrestored",re,!1),t.addEventListener("webglcontextcreationerror",ue,!1),U===null){let k="webgl2";if(U=Ze(k,w),U===null)throw Ze(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw Ve("WebGLRenderer: "+w.message),w}let We,lt,pe,Ke,R,y,V,J,ee,he,ne,Y,Q,ge,Se,fe,le,me,Ge,qe,N,ae,K;function xe(){We=new dy(U),We.init(),N=new jM(U,We),lt=new sy(U,We,e,N),pe=new $M(U,We),lt.reversedDepthBuffer&&h&&pe.buffers.depth.setReversed(!0),Ke=new gy(U),R=new OM,y=new QM(U,We,pe,R,lt,N,Ke),V=new fy(C),J=new y0(U),ae=new iy(U,J),ee=new py(U,J,Ke,ae),he=new xy(U,ee,J,ae,Ke),me=new _y(U,lt,y),Se=new ay(R),ne=new FM(C,V,We,lt,ae,Se),Y=new iS(C,R),Q=new kM,ge=new XM(We),le=new ny(C,V,pe,he,g,l),fe=new KM(C,he,lt),K=new rS(U,Ke,lt,pe),Ge=new ry(U,We,Ke),qe=new my(U,We,Ke),Ke.programs=ne.programs,C.capabilities=lt,C.extensions=We,C.properties=R,C.renderLists=Q,C.shadowMap=fe,C.state=pe,C.info=Ke}xe(),_!==ti&&(E=new yy(_,t.width,t.height,i,s));let ce=new cf(C,U);this.xr=ce,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){let w=We.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){let w=We.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return Ie},this.setPixelRatio=function(w){w!==void 0&&(Ie=w,this.setSize(Xe,Oe,!1))},this.getSize=function(w){return w.set(Xe,Oe)},this.setSize=function(w,k,q=!0){if(ce.isPresenting){ke("WebGLRenderer: Can't change size while VR device is presenting.");return}Xe=w,Oe=k,t.width=Math.floor(w*Ie),t.height=Math.floor(k*Ie),q===!0&&(t.style.width=w+"px",t.style.height=k+"px"),E!==null&&E.setSize(t.width,t.height),this.setViewport(0,0,w,k)},this.getDrawingBufferSize=function(w){return w.set(Xe*Ie,Oe*Ie).floor()},this.setDrawingBufferSize=function(w,k,q){Xe=w,Oe=k,Ie=q,t.width=Math.floor(w*q),t.height=Math.floor(k*q),this.setViewport(0,0,w,k)},this.setEffects=function(w){if(_===ti){Ve("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(w){for(let k=0;k<w.length;k++)if(w[k].isOutputPass===!0){ke("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}E.setEffects(w||[])},this.getCurrentViewport=function(w){return w.copy(Z)},this.getViewport=function(w){return w.copy(se)},this.setViewport=function(w,k,q,G){w.isVector4?se.set(w.x,w.y,w.z,w.w):se.set(w,k,q,G),pe.viewport(Z.copy(se).multiplyScalar(Ie).round())},this.getScissor=function(w){return w.copy(Ee)},this.setScissor=function(w,k,q,G){w.isVector4?Ee.set(w.x,w.y,w.z,w.w):Ee.set(w,k,q,G),pe.scissor(j.copy(Ee).multiplyScalar(Ie).round())},this.getScissorTest=function(){return Fe},this.setScissorTest=function(w){pe.setScissorTest(Fe=w)},this.setOpaqueSort=function(w){$=w},this.setTransparentSort=function(w){oe=w},this.getClearColor=function(w){return w.copy(le.getClearColor())},this.setClearColor=function(){le.setClearColor(...arguments)},this.getClearAlpha=function(){return le.getClearAlpha()},this.setClearAlpha=function(){le.setClearAlpha(...arguments)},this.clear=function(w=!0,k=!0,q=!0){let G=0;if(w){let H=!1;if(L!==null){let _e=L.texture.format;H=p.has(_e)}if(H){let _e=L.texture.type,ve=m.has(_e),Me=le.getClearColor(),Pe=le.getClearAlpha(),De=Me.r,Je=Me.g,et=Me.b;ve?(v[0]=De,v[1]=Je,v[2]=et,v[3]=Pe,U.clearBufferuiv(U.COLOR,0,v)):(S[0]=De,S[1]=Je,S[2]=et,S[3]=Pe,U.clearBufferiv(U.COLOR,0,S))}else G|=U.COLOR_BUFFER_BIT}k&&(G|=U.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),q&&(G|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G!==0&&U.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(w){w.setRenderer(this),I=w},this.dispose=function(){t.removeEventListener("webglcontextlost",te,!1),t.removeEventListener("webglcontextrestored",re,!1),t.removeEventListener("webglcontextcreationerror",ue,!1),le.dispose(),Q.dispose(),ge.dispose(),R.dispose(),V.dispose(),he.dispose(),ae.dispose(),K.dispose(),ne.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",it),ce.removeEventListener("sessionend",Ct),Rt.stop()};function te(w){w.preventDefault(),Oh("WebGLRenderer: Context Lost."),P=!0}function re(){Oh("WebGLRenderer: Context Restored."),P=!1;let w=Ke.autoReset,k=fe.enabled,q=fe.autoUpdate,G=fe.needsUpdate,H=fe.type;xe(),Ke.autoReset=w,fe.enabled=k,fe.autoUpdate=q,fe.needsUpdate=G,fe.type=H}function ue(w){Ve("WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function Ne(w){let k=w.target;k.removeEventListener("dispose",Ne),ie(k)}function ie(w){Ue(w),R.remove(w)}function Ue(w){let k=R.get(w).programs;k!==void 0&&(k.forEach(function(q){ne.releaseProgram(q)}),w.isShaderMaterial&&ne.releaseShaderCache(w))}this.renderBufferDirect=function(w,k,q,G,H,_e){k===null&&(k=X);let ve=H.isMesh&&H.matrixWorld.determinant()<0,Me=nn(w,k,q,G,H);pe.setMaterial(G,ve);let Pe=q.index,De=1;if(G.wireframe===!0){if(Pe=ee.getWireframeAttribute(q),Pe===void 0)return;De=2}let Je=q.drawRange,et=q.attributes.position,Le=Je.start*De,xt=(Je.start+Je.count)*De;_e!==null&&(Le=Math.max(Le,_e.start*De),xt=Math.min(xt,(_e.start+_e.count)*De)),Pe!==null?(Le=Math.max(Le,0),xt=Math.min(xt,Pe.count)):et!=null&&(Le=Math.max(Le,0),xt=Math.min(xt,et.count));let Gt=xt-Le;if(Gt<0||Gt===1/0)return;ae.setup(H,G,Me,q,Pe);let Ut,yt=Ge;if(Pe!==null&&(Ut=J.get(Pe),yt=qe,yt.setIndex(Ut)),H.isMesh)G.wireframe===!0?(pe.setLineWidth(G.wireframeLinewidth*It()),yt.setMode(U.LINES)):yt.setMode(U.TRIANGLES);else if(H.isLine){let pn=G.linewidth;pn===void 0&&(pn=1),pe.setLineWidth(pn*It()),H.isLineSegments?yt.setMode(U.LINES):H.isLineLoop?yt.setMode(U.LINE_LOOP):yt.setMode(U.LINE_STRIP)}else H.isPoints?yt.setMode(U.POINTS):H.isSprite&&yt.setMode(U.TRIANGLES);if(H.isBatchedMesh)if(We.get("WEBGL_multi_draw"))yt.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{let pn=H._multiDrawStarts,we=H._multiDrawCounts,Yn=H._multiDrawCount,ht=Pe?J.get(Pe).bytesPerElement:1,hi=R.get(G).currentProgram.getUniforms();for(let Pi=0;Pi<Yn;Pi++)hi.setValue(U,"_gl_DrawID",Pi),yt.render(pn[Pi]/ht,we[Pi])}else if(H.isInstancedMesh)yt.renderInstances(Le,Gt,H.count);else if(q.isInstancedBufferGeometry){let pn=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,we=Math.min(q.instanceCount,pn);yt.renderInstances(Le,Gt,we)}else yt.render(Le,Gt)};function Re(w,k,q){w.transparent===!0&&w.side===di&&w.forceSinglePass===!1?(w.side=Pn,w.needsUpdate=!0,tn(w,k,q),w.side=tr,w.needsUpdate=!0,tn(w,k,q),w.side=di):tn(w,k,q)}this.compile=function(w,k,q=null){q===null&&(q=w),b=ge.get(q),b.init(k),x.push(b),q.traverseVisible(function(H){H.isLight&&H.layers.test(k.layers)&&(b.pushLight(H),H.castShadow&&b.pushShadow(H))}),w!==q&&w.traverseVisible(function(H){H.isLight&&H.layers.test(k.layers)&&(b.pushLight(H),H.castShadow&&b.pushShadow(H))}),b.setupLights();let G=new Set;return w.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;let _e=H.material;if(_e)if(Array.isArray(_e))for(let ve=0;ve<_e.length;ve++){let Me=_e[ve];Re(Me,q,H),G.add(Me)}else Re(_e,q,H),G.add(_e)}),b=x.pop(),G},this.compileAsync=function(w,k,q=null){let G=this.compile(w,k,q);return new Promise(H=>{function _e(){if(G.forEach(function(ve){R.get(ve).currentProgram.isReady()&&G.delete(ve)}),G.size===0){H(w);return}setTimeout(_e,10)}We.get("KHR_parallel_shader_compile")!==null?_e():setTimeout(_e,10)})};let He=null;function Xt(w){He&&He(w)}function it(){Rt.stop()}function Ct(){Rt.start()}let Rt=new um;Rt.setAnimationLoop(Xt),typeof self<"u"&&Rt.setContext(self),this.setAnimationLoop=function(w){He=w,ce.setAnimationLoop(w),w===null?Rt.stop():Rt.start()},ce.addEventListener("sessionstart",it),ce.addEventListener("sessionend",Ct),this.render=function(w,k){if(k!==void 0&&k.isCamera!==!0){Ve("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;I!==null&&I.renderStart(w,k);let q=ce.enabled===!0&&ce.isPresenting===!0,G=E!==null&&(L===null||q)&&E.begin(C,L);if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(E===null||E.isCompositing()===!1)&&(ce.cameraAutoUpdate===!0&&ce.updateCamera(k),k=ce.getCamera()),w.isScene===!0&&w.onBeforeRender(C,w,k,L),b=ge.get(w,x.length),b.init(k),b.state.textureUnits=y.getTextureUnits(),x.push(b),ze.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),Ce.setFromProjectionMatrix(ze,Ti,k.reversedDepth),Te=this.localClippingEnabled,je=Se.init(this.clippingPlanes,Te),A=Q.get(w,T.length),A.init(),T.push(A),ce.enabled===!0&&ce.isPresenting===!0){let ve=C.xr.getDepthSensingMesh();ve!==null&&Tt(ve,k,-1/0,C.sortObjects)}Tt(w,k,0,C.sortObjects),A.finish(),C.sortObjects===!0&&A.sort($,oe),at=ce.enabled===!1||ce.isPresenting===!1||ce.hasDepthSensing()===!1,at&&le.addToRenderList(A,w),this.info.render.frame++,je===!0&&Se.beginShadows();let H=b.state.shadowsArray;if(fe.render(H,w,k),je===!0&&Se.endShadows(),this.info.autoReset===!0&&this.info.reset(),(G&&E.hasRenderPass())===!1){let ve=A.opaque,Me=A.transmissive;if(b.setupLights(),k.isArrayCamera){let Pe=k.cameras;if(Me.length>0)for(let De=0,Je=Pe.length;De<Je;De++){let et=Pe[De];pt(ve,Me,w,et)}at&&le.render(w);for(let De=0,Je=Pe.length;De<Je;De++){let et=Pe[De];vt(A,w,et,et.viewport)}}else Me.length>0&&pt(ve,Me,w,k),at&&le.render(w),vt(A,w,k)}L!==null&&z===0&&(y.updateMultisampleRenderTarget(L),y.updateRenderTargetMipmap(L)),G&&E.end(C),w.isScene===!0&&w.onAfterRender(C,w,k),ae.resetDefaultState(),O=-1,F=null,x.pop(),x.length>0?(b=x[x.length-1],y.setTextureUnits(b.state.textureUnits),je===!0&&Se.setGlobalState(C.clippingPlanes,b.state.camera)):b=null,T.pop(),T.length>0?A=T[T.length-1]:A=null,I!==null&&I.renderEnd()};function Tt(w,k,q,G){if(w.visible===!1)return;if(w.layers.test(k.layers)){if(w.isGroup)q=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(k);else if(w.isLightProbeGrid)b.pushLightProbeGrid(w);else if(w.isLight)b.pushLight(w),w.castShadow&&b.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||Ce.intersectsSprite(w)){G&&Be.setFromMatrixPosition(w.matrixWorld).applyMatrix4(ze);let ve=he.update(w),Me=w.material;Me.visible&&A.push(w,ve,Me,q,Be.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||Ce.intersectsObject(w))){let ve=he.update(w),Me=w.material;if(G&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),Be.copy(w.boundingSphere.center)):(ve.boundingSphere===null&&ve.computeBoundingSphere(),Be.copy(ve.boundingSphere.center)),Be.applyMatrix4(w.matrixWorld).applyMatrix4(ze)),Array.isArray(Me)){let Pe=ve.groups;for(let De=0,Je=Pe.length;De<Je;De++){let et=Pe[De],Le=Me[et.materialIndex];Le&&Le.visible&&A.push(w,ve,Le,q,Be.z,et)}}else Me.visible&&A.push(w,ve,Me,q,Be.z,null)}}let _e=w.children;for(let ve=0,Me=_e.length;ve<Me;ve++)Tt(_e[ve],k,q,G)}function vt(w,k,q,G){let{opaque:H,transmissive:_e,transparent:ve}=w;b.setupLightsView(q),je===!0&&Se.setGlobalState(C.clippingPlanes,q),G&&pe.viewport(Z.copy(G)),H.length>0&&dn(H,k,q),_e.length>0&&dn(_e,k,q),ve.length>0&&dn(ve,k,q),pe.buffers.depth.setTest(!0),pe.buffers.depth.setMask(!0),pe.buffers.color.setMask(!0),pe.setPolygonOffset(!1)}function pt(w,k,q,G){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[G.id]===void 0){let Le=We.has("EXT_color_buffer_half_float")||We.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[G.id]=new $n(1,1,{generateMipmaps:!0,type:Le?ki:ti,minFilter:Lr,samples:Math.max(4,lt.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ot.workingColorSpace})}let _e=b.state.transmissionRenderTarget[G.id],ve=G.viewport||Z;_e.setSize(ve.z*C.transmissionResolutionScale,ve.w*C.transmissionResolutionScale);let Me=C.getRenderTarget(),Pe=C.getActiveCubeFace(),De=C.getActiveMipmapLevel();C.setRenderTarget(_e),C.getClearColor(de),be=C.getClearAlpha(),be<1&&C.setClearColor(16777215,.5),C.clear(),at&&le.render(q);let Je=C.toneMapping;C.toneMapping=wi;let et=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),b.setupLightsView(G),je===!0&&Se.setGlobalState(C.clippingPlanes,G),dn(w,q,G),y.updateMultisampleRenderTarget(_e),y.updateRenderTargetMipmap(_e),We.has("WEBGL_multisampled_render_to_texture")===!1){let Le=!1;for(let xt=0,Gt=k.length;xt<Gt;xt++){let Ut=k[xt],{object:yt,geometry:pn,material:we,group:Yn}=Ut;if(we.side===di&&yt.layers.test(G.layers)){let ht=we.side;we.side=Pn,we.needsUpdate=!0,wt(yt,q,G,pn,we,Yn),we.side=ht,we.needsUpdate=!0,Le=!0}}Le===!0&&(y.updateMultisampleRenderTarget(_e),y.updateRenderTargetMipmap(_e))}C.setRenderTarget(Me,Pe,De),C.setClearColor(de,be),et!==void 0&&(G.viewport=et),C.toneMapping=Je}function dn(w,k,q){let G=k.isScene===!0?k.overrideMaterial:null;for(let H=0,_e=w.length;H<_e;H++){let ve=w[H],{object:Me,geometry:Pe,group:De}=ve,Je=ve.material;Je.allowOverride===!0&&G!==null&&(Je=G),Me.layers.test(q.layers)&&wt(Me,k,q,Pe,Je,De)}}function wt(w,k,q,G,H,_e){w.onBeforeRender(C,k,q,G,H,_e),w.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),H.onBeforeRender(C,k,q,G,w,_e),H.transparent===!0&&H.side===di&&H.forceSinglePass===!1?(H.side=Pn,H.needsUpdate=!0,C.renderBufferDirect(q,k,G,H,w,_e),H.side=tr,H.needsUpdate=!0,C.renderBufferDirect(q,k,G,H,w,_e),H.side=di):C.renderBufferDirect(q,k,G,H,w,_e),w.onAfterRender(C,k,q,G,H,_e)}function tn(w,k,q){k.isScene!==!0&&(k=X);let G=R.get(w),H=b.state.lights,_e=b.state.shadowsArray,ve=H.state.version,Me=ne.getParameters(w,H.state,_e,k,q,b.state.lightProbeGridArray),Pe=ne.getProgramCacheKey(Me),De=G.programs;G.environment=w.isMeshStandardMaterial||w.isMeshLambertMaterial||w.isMeshPhongMaterial?k.environment:null,G.fog=k.fog;let Je=w.isMeshStandardMaterial||w.isMeshLambertMaterial&&!w.envMap||w.isMeshPhongMaterial&&!w.envMap;G.envMap=V.get(w.envMap||G.environment,Je),G.envMapRotation=G.environment!==null&&w.envMap===null?k.environmentRotation:w.envMapRotation,De===void 0&&(w.addEventListener("dispose",Ne),De=new Map,G.programs=De);let et=De.get(Pe);if(et!==void 0){if(G.currentProgram===et&&G.lightsStateVersion===ve)return qt(w,Me),et}else Me.uniforms=ne.getUniforms(w),I!==null&&w.isNodeMaterial&&I.build(w,q,Me),w.onBeforeCompile(Me,C),et=ne.acquireProgram(Me,Pe),De.set(Pe,et),G.uniforms=Me.uniforms;let Le=G.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Le.clippingPlanes=Se.uniform),qt(w,Me),G.needsLights=Rs(w),G.lightsStateVersion=ve,G.needsLights&&(Le.ambientLightColor.value=H.state.ambient,Le.lightProbe.value=H.state.probe,Le.directionalLights.value=H.state.directional,Le.directionalLightShadows.value=H.state.directionalShadow,Le.spotLights.value=H.state.spot,Le.spotLightShadows.value=H.state.spotShadow,Le.rectAreaLights.value=H.state.rectArea,Le.ltc_1.value=H.state.rectAreaLTC1,Le.ltc_2.value=H.state.rectAreaLTC2,Le.pointLights.value=H.state.point,Le.pointLightShadows.value=H.state.pointShadow,Le.hemisphereLights.value=H.state.hemi,Le.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Le.spotLightMatrix.value=H.state.spotLightMatrix,Le.spotLightMap.value=H.state.spotLightMap,Le.pointShadowMatrix.value=H.state.pointShadowMatrix),G.lightProbeGrid=b.state.lightProbeGridArray.length>0,G.currentProgram=et,G.uniformsList=null,et}function qn(w){if(w.uniformsList===null){let k=w.currentProgram.getUniforms();w.uniformsList=ra.seqWithValue(k.seq,w.uniforms)}return w.uniformsList}function qt(w,k){let q=R.get(w);q.outputColorSpace=k.outputColorSpace,q.batching=k.batching,q.batchingColor=k.batchingColor,q.instancing=k.instancing,q.instancingColor=k.instancingColor,q.instancingMorph=k.instancingMorph,q.skinning=k.skinning,q.morphTargets=k.morphTargets,q.morphNormals=k.morphNormals,q.morphColors=k.morphColors,q.morphTargetsCount=k.morphTargetsCount,q.numClippingPlanes=k.numClippingPlanes,q.numIntersection=k.numClipIntersection,q.vertexAlphas=k.vertexAlphas,q.vertexTangents=k.vertexTangents,q.toneMapping=k.toneMapping}function Kt(w,k){if(w.length===0)return null;if(w.length===1)return w[0].texture!==null?w[0]:null;M.setFromMatrixPosition(k.matrixWorld);for(let q=0,G=w.length;q<G;q++){let H=w[q];if(H.texture!==null&&H.boundingBox.containsPoint(M))return H}return null}function nn(w,k,q,G,H){k.isScene!==!0&&(k=X),y.resetTextureUnits();let _e=k.fog,ve=G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial?k.environment:null,Me=L===null?C.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:ot.workingColorSpace,Pe=G.isMeshStandardMaterial||G.isMeshLambertMaterial&&!G.envMap||G.isMeshPhongMaterial&&!G.envMap,De=V.get(G.envMap||ve,Pe),Je=G.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,et=!!q.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Le=!!q.morphAttributes.position,xt=!!q.morphAttributes.normal,Gt=!!q.morphAttributes.color,Ut=wi;G.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(Ut=C.toneMapping);let yt=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,pn=yt!==void 0?yt.length:0,we=R.get(G),Yn=b.state.lights;if(je===!0&&(Te===!0||w!==F)){let Et=w===F&&G.id===O;Se.setState(G,w,Et)}let ht=!1;G.version===we.__version?(we.needsLights&&we.lightsStateVersion!==Yn.state.version||we.outputColorSpace!==Me||H.isBatchedMesh&&we.batching===!1||!H.isBatchedMesh&&we.batching===!0||H.isBatchedMesh&&we.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&we.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&we.instancing===!1||!H.isInstancedMesh&&we.instancing===!0||H.isSkinnedMesh&&we.skinning===!1||!H.isSkinnedMesh&&we.skinning===!0||H.isInstancedMesh&&we.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&we.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&we.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&we.instancingMorph===!1&&H.morphTexture!==null||we.envMap!==De||G.fog===!0&&we.fog!==_e||we.numClippingPlanes!==void 0&&(we.numClippingPlanes!==Se.numPlanes||we.numIntersection!==Se.numIntersection)||we.vertexAlphas!==Je||we.vertexTangents!==et||we.morphTargets!==Le||we.morphNormals!==xt||we.morphColors!==Gt||we.toneMapping!==Ut||we.morphTargetsCount!==pn||!!we.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(ht=!0):(ht=!0,we.__version=G.version);let hi=we.currentProgram;ht===!0&&(hi=tn(G,k,H),I&&G.isNodeMaterial&&I.onUpdateProgram(G,hi,we));let Pi=!1,pr=!1,Ps=!1,Mt=hi.getUniforms(),Ht=we.uniforms;if(pe.useProgram(hi.program)&&(Pi=!0,pr=!0,Ps=!0),G.id!==O&&(O=G.id,pr=!0),we.needsLights){let Et=Kt(b.state.lightProbeGridArray,H);we.lightProbeGrid!==Et&&(we.lightProbeGrid=Et,pr=!0)}if(Pi||F!==w){pe.buffers.depth.getReversed()&&w.reversedDepth!==!0&&(w._reversedDepth=!0,w.updateProjectionMatrix()),Mt.setValue(U,"projectionMatrix",w.projectionMatrix),Mt.setValue(U,"viewMatrix",w.matrixWorldInverse);let gr=Mt.map.cameraPosition;gr!==void 0&&gr.setValue(U,$e.setFromMatrixPosition(w.matrixWorld)),lt.logarithmicDepthBuffer&&Mt.setValue(U,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&Mt.setValue(U,"isOrthographic",w.isOrthographicCamera===!0),F!==w&&(F=w,pr=!0,Ps=!0)}if(we.needsLights&&(Yn.state.directionalShadowMap.length>0&&Mt.setValue(U,"directionalShadowMap",Yn.state.directionalShadowMap,y),Yn.state.spotShadowMap.length>0&&Mt.setValue(U,"spotShadowMap",Yn.state.spotShadowMap,y),Yn.state.pointShadowMap.length>0&&Mt.setValue(U,"pointShadowMap",Yn.state.pointShadowMap,y)),H.isSkinnedMesh){Mt.setOptional(U,H,"bindMatrix"),Mt.setOptional(U,H,"bindMatrixInverse");let Et=H.skeleton;Et&&(Et.boneTexture===null&&Et.computeBoneTexture(),Mt.setValue(U,"boneTexture",Et.boneTexture,y))}H.isBatchedMesh&&(Mt.setOptional(U,H,"batchingTexture"),Mt.setValue(U,"batchingTexture",H._matricesTexture,y),Mt.setOptional(U,H,"batchingIdTexture"),Mt.setValue(U,"batchingIdTexture",H._indirectTexture,y),Mt.setOptional(U,H,"batchingColorTexture"),H._colorsTexture!==null&&Mt.setValue(U,"batchingColorTexture",H._colorsTexture,y));let mr=q.morphAttributes;if((mr.position!==void 0||mr.normal!==void 0||mr.color!==void 0)&&me.update(H,q,hi),(pr||we.receiveShadow!==H.receiveShadow)&&(we.receiveShadow=H.receiveShadow,Mt.setValue(U,"receiveShadow",H.receiveShadow)),(G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial)&&G.envMap===null&&k.environment!==null&&(Ht.envMapIntensity.value=k.environmentIntensity),Ht.dfgLUT!==void 0&&(Ht.dfgLUT.value=aS()),pr){if(Mt.setValue(U,"toneMappingExposure",C.toneMappingExposure),we.needsLights&&Zi(Ht,Ps),_e&&G.fog===!0&&Y.refreshFogUniforms(Ht,_e),Y.refreshMaterialUniforms(Ht,G,Ie,Oe,b.state.transmissionRenderTarget[w.id]),we.needsLights&&we.lightProbeGrid){let Et=we.lightProbeGrid;Ht.probesSH.value=Et.texture,Ht.probesMin.value.copy(Et.boundingBox.min),Ht.probesMax.value.copy(Et.boundingBox.max),Ht.probesResolution.value.copy(Et.resolution)}ra.upload(U,qn(we),Ht,y)}if(G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(ra.upload(U,qn(we),Ht,y),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&Mt.setValue(U,"center",H.center),Mt.setValue(U,"modelViewMatrix",H.modelViewMatrix),Mt.setValue(U,"normalMatrix",H.normalMatrix),Mt.setValue(U,"modelMatrix",H.matrixWorld),G.uniformsGroups!==void 0){let Et=G.uniformsGroups;for(let gr=0,Is=Et.length;gr<Is;gr++){let Id=Et[gr];K.update(Id,hi),K.bind(Id,hi)}}return hi}function Zi(w,k){w.ambientLightColor.needsUpdate=k,w.lightProbe.needsUpdate=k,w.directionalLights.needsUpdate=k,w.directionalLightShadows.needsUpdate=k,w.pointLights.needsUpdate=k,w.pointLightShadows.needsUpdate=k,w.spotLights.needsUpdate=k,w.spotLightShadows.needsUpdate=k,w.rectAreaLights.needsUpdate=k,w.hemisphereLights.needsUpdate=k}function Rs(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(w,k,q){let G=R.get(w);G.__autoAllocateDepthBuffer=w.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),R.get(w.texture).__webglTexture=k,R.get(w.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:q,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(w,k){let q=R.get(w);q.__webglFramebuffer=k,q.__useDefaultFramebuffer=k===void 0};let rn=U.createFramebuffer();this.setRenderTarget=function(w,k=0,q=0){L=w,B=k,z=q;let G=null,H=!1,_e=!1;if(w){let Me=R.get(w);if(Me.__useDefaultFramebuffer!==void 0){pe.bindFramebuffer(U.FRAMEBUFFER,Me.__webglFramebuffer),Z.copy(w.viewport),j.copy(w.scissor),D=w.scissorTest,pe.viewport(Z),pe.scissor(j),pe.setScissorTest(D),O=-1;return}else if(Me.__webglFramebuffer===void 0)y.setupRenderTarget(w);else if(Me.__hasExternalTextures)y.rebindTextures(w,R.get(w.texture).__webglTexture,R.get(w.depthTexture).__webglTexture);else if(w.depthBuffer){let Je=w.depthTexture;if(Me.__boundDepthTexture!==Je){if(Je!==null&&R.has(Je)&&(w.width!==Je.image.width||w.height!==Je.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");y.setupDepthRenderbuffer(w)}}let Pe=w.texture;(Pe.isData3DTexture||Pe.isDataArrayTexture||Pe.isCompressedArrayTexture)&&(_e=!0);let De=R.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(De[k])?G=De[k][q]:G=De[k],H=!0):w.samples>0&&y.useMultisampledRTT(w)===!1?G=R.get(w).__webglMultisampledFramebuffer:Array.isArray(De)?G=De[q]:G=De,Z.copy(w.viewport),j.copy(w.scissor),D=w.scissorTest}else Z.copy(se).multiplyScalar(Ie).floor(),j.copy(Ee).multiplyScalar(Ie).floor(),D=Fe;if(q!==0&&(G=rn),pe.bindFramebuffer(U.FRAMEBUFFER,G)&&pe.drawBuffers(w,G),pe.viewport(Z),pe.scissor(j),pe.setScissorTest(D),H){let Me=R.get(w.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+k,Me.__webglTexture,q)}else if(_e){let Me=k;for(let Pe=0;Pe<w.textures.length;Pe++){let De=R.get(w.textures[Pe]);U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0+Pe,De.__webglTexture,q,Me)}}else if(w!==null&&q!==0){let Me=R.get(w.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Me.__webglTexture,q)}O=-1},this.readRenderTargetPixels=function(w,k,q,G,H,_e,ve,Me=0){if(!(w&&w.isWebGLRenderTarget)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=R.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&ve!==void 0&&(Pe=Pe[ve]),Pe){pe.bindFramebuffer(U.FRAMEBUFFER,Pe);try{let De=w.textures[Me],Je=De.format,et=De.type;if(w.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+Me),!lt.textureFormatReadable(Je)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!lt.textureTypeReadable(et)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=w.width-G&&q>=0&&q<=w.height-H&&U.readPixels(k,q,G,H,N.convert(Je),N.convert(et),_e)}finally{let De=L!==null?R.get(L).__webglFramebuffer:null;pe.bindFramebuffer(U.FRAMEBUFFER,De)}}},this.readRenderTargetPixelsAsync=async function(w,k,q,G,H,_e,ve,Me=0){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pe=R.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&ve!==void 0&&(Pe=Pe[ve]),Pe)if(k>=0&&k<=w.width-G&&q>=0&&q<=w.height-H){pe.bindFramebuffer(U.FRAMEBUFFER,Pe);let De=w.textures[Me],Je=De.format,et=De.type;if(w.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+Me),!lt.textureFormatReadable(Je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!lt.textureTypeReadable(et))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Le=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,Le),U.bufferData(U.PIXEL_PACK_BUFFER,_e.byteLength,U.STREAM_READ),U.readPixels(k,q,G,H,N.convert(Je),N.convert(et),0);let xt=L!==null?R.get(L).__webglFramebuffer:null;pe.bindFramebuffer(U.FRAMEBUFFER,xt);let Gt=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await Op(U,Gt,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,Le),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,_e),U.deleteBuffer(Le),U.deleteSync(Gt),_e}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(w,k=null,q=0){let G=Math.pow(2,-q),H=Math.floor(w.image.width*G),_e=Math.floor(w.image.height*G),ve=k!==null?k.x:0,Me=k!==null?k.y:0;y.setTexture2D(w,0),U.copyTexSubImage2D(U.TEXTURE_2D,q,0,0,ve,Me,H,_e),pe.unbindTexture()};let Vt=U.createFramebuffer(),ui=U.createFramebuffer();this.copyTextureToTexture=function(w,k,q=null,G=null,H=0,_e=0){let ve,Me,Pe,De,Je,et,Le,xt,Gt,Ut=w.isCompressedTexture?w.mipmaps[_e]:w.image;if(q!==null)ve=q.max.x-q.min.x,Me=q.max.y-q.min.y,Pe=q.isBox3?q.max.z-q.min.z:1,De=q.min.x,Je=q.min.y,et=q.isBox3?q.min.z:0;else{let Ht=Math.pow(2,-H);ve=Math.floor(Ut.width*Ht),Me=Math.floor(Ut.height*Ht),w.isDataArrayTexture?Pe=Ut.depth:w.isData3DTexture?Pe=Math.floor(Ut.depth*Ht):Pe=1,De=0,Je=0,et=0}G!==null?(Le=G.x,xt=G.y,Gt=G.z):(Le=0,xt=0,Gt=0);let yt=N.convert(k.format),pn=N.convert(k.type),we;k.isData3DTexture?(y.setTexture3D(k,0),we=U.TEXTURE_3D):k.isDataArrayTexture||k.isCompressedArrayTexture?(y.setTexture2DArray(k,0),we=U.TEXTURE_2D_ARRAY):(y.setTexture2D(k,0),we=U.TEXTURE_2D),pe.activeTexture(U.TEXTURE0),pe.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,k.flipY),pe.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),pe.pixelStorei(U.UNPACK_ALIGNMENT,k.unpackAlignment);let Yn=pe.getParameter(U.UNPACK_ROW_LENGTH),ht=pe.getParameter(U.UNPACK_IMAGE_HEIGHT),hi=pe.getParameter(U.UNPACK_SKIP_PIXELS),Pi=pe.getParameter(U.UNPACK_SKIP_ROWS),pr=pe.getParameter(U.UNPACK_SKIP_IMAGES);pe.pixelStorei(U.UNPACK_ROW_LENGTH,Ut.width),pe.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Ut.height),pe.pixelStorei(U.UNPACK_SKIP_PIXELS,De),pe.pixelStorei(U.UNPACK_SKIP_ROWS,Je),pe.pixelStorei(U.UNPACK_SKIP_IMAGES,et);let Ps=w.isDataArrayTexture||w.isData3DTexture,Mt=k.isDataArrayTexture||k.isData3DTexture;if(w.isDepthTexture){let Ht=R.get(w),mr=R.get(k),Et=R.get(Ht.__renderTarget),gr=R.get(mr.__renderTarget);pe.bindFramebuffer(U.READ_FRAMEBUFFER,Et.__webglFramebuffer),pe.bindFramebuffer(U.DRAW_FRAMEBUFFER,gr.__webglFramebuffer);for(let Is=0;Is<Pe;Is++)Ps&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,R.get(w).__webglTexture,H,et+Is),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,R.get(k).__webglTexture,_e,Gt+Is)),U.blitFramebuffer(De,Je,ve,Me,Le,xt,ve,Me,U.DEPTH_BUFFER_BIT,U.NEAREST);pe.bindFramebuffer(U.READ_FRAMEBUFFER,null),pe.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(H!==0||w.isRenderTargetTexture||R.has(w)){let Ht=R.get(w),mr=R.get(k);pe.bindFramebuffer(U.READ_FRAMEBUFFER,Vt),pe.bindFramebuffer(U.DRAW_FRAMEBUFFER,ui);for(let Et=0;Et<Pe;Et++)Ps?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Ht.__webglTexture,H,et+Et):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Ht.__webglTexture,H),Mt?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,mr.__webglTexture,_e,Gt+Et):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,mr.__webglTexture,_e),H!==0?U.blitFramebuffer(De,Je,ve,Me,Le,xt,ve,Me,U.COLOR_BUFFER_BIT,U.NEAREST):Mt?U.copyTexSubImage3D(we,_e,Le,xt,Gt+Et,De,Je,ve,Me):U.copyTexSubImage2D(we,_e,Le,xt,De,Je,ve,Me);pe.bindFramebuffer(U.READ_FRAMEBUFFER,null),pe.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else Mt?w.isDataTexture||w.isData3DTexture?U.texSubImage3D(we,_e,Le,xt,Gt,ve,Me,Pe,yt,pn,Ut.data):k.isCompressedArrayTexture?U.compressedTexSubImage3D(we,_e,Le,xt,Gt,ve,Me,Pe,yt,Ut.data):U.texSubImage3D(we,_e,Le,xt,Gt,ve,Me,Pe,yt,pn,Ut):w.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,_e,Le,xt,ve,Me,yt,pn,Ut.data):w.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,_e,Le,xt,Ut.width,Ut.height,yt,Ut.data):U.texSubImage2D(U.TEXTURE_2D,_e,Le,xt,ve,Me,yt,pn,Ut);pe.pixelStorei(U.UNPACK_ROW_LENGTH,Yn),pe.pixelStorei(U.UNPACK_IMAGE_HEIGHT,ht),pe.pixelStorei(U.UNPACK_SKIP_PIXELS,hi),pe.pixelStorei(U.UNPACK_SKIP_ROWS,Pi),pe.pixelStorei(U.UNPACK_SKIP_IMAGES,pr),_e===0&&k.generateMipmaps&&U.generateMipmap(we),pe.unbindTexture()},this.initRenderTarget=function(w){R.get(w).__webglFramebuffer===void 0&&y.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?y.setTextureCube(w,0):w.isData3DTexture?y.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?y.setTexture2DArray(w,0):y.setTexture2D(w,0),pe.unbindTexture()},this.resetState=function(){B=0,z=0,L=null,pe.reset(),ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ti}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=ot._getDrawingBufferColorSpace(e),t.unpackColorSpace=ot._getUnpackColorSpace()}}});function Tm(){if(xm)return;let r=document.getElementById("space-canvas");if(!r)return;xm=!0,po=new Gc({canvas:r,alpha:!0,antialias:!0}),po.setSize(window.innerWidth,window.innerHeight),po.setPixelRatio(window.devicePixelRatio),aa=new Va;let e=new _n(75,window.innerWidth/window.innerHeight,.1,1e3);e.position.z=400,uf=new zn;let t=4e3,n=new Float32Array(t*3);for(let p=0;p<t*3;p++)n[p]=(Math.random()-.5)*1500;uf.setAttribute("position",new En(n,3));let i=()=>{let p=document.createElement("canvas");p.width=16,p.height=16;let m=p.getContext("2d");if(m){let v=m.createRadialGradient(8,8,0,8,8,8);v.addColorStop(0,"rgba(255,255,255,1)"),v.addColorStop(.2,"rgba(210,230,255,0.8)"),v.addColorStop(.5,"rgba(100,150,255,0.2)"),v.addColorStop(1,"rgba(0,0,0,0)"),m.fillStyle=v,m.fillRect(0,0,16,16)}return new $s(p)};hf=new Ks({size:2,map:i(),transparent:!0,opacity:.9,color:16777215,blending:ea,depthWrite:!1}),Xc=new Xa(uf,hf),aa.add(Xc),vm=new Za(.8,0,150,8),ym=new Cr({color:16777215,transparent:!0,opacity:.9,blending:ea,depthWrite:!1}),Or=new Rn(vm,ym),aa.add(Or);let s=new W(-10,-5,-8),a=s.clone().normalize();Or.quaternion.setFromUnitVectors(new W(0,1,0),a);let o=()=>{Or.position.set(Math.random()*1e3+800,Math.random()*800+500,(Math.random()-.5)*1e3)};o(),[{name:"Python",color:"#3776AB"},{name:"Rust",color:"#DEA584"},{name:"Go",color:"#00ADD8"},{name:"FastAPI",color:"#009688"}].forEach((p,m)=>{let v=document.createElement("canvas");v.width=256,v.height=256;let S=v.getContext("2d");S&&(S.fillStyle=p.color,S.beginPath(),S.arc(128,128,120,0,Math.PI*2),S.fill(),S.fillStyle="white",S.font="bold 40px Inter, sans-serif",S.textAlign="center",S.textBaseline="middle",S.fillText(p.name,128,128));let M=new $s(v),A=new ss(30,30),b=new Cr({map:M,transparent:!0,opacity:.8,side:di,depthWrite:!1}),T=new Rn(A,b);T.position.set((Math.random()-.5)*400,(Math.random()-.5)*400,(Math.random()-.5)*200-100),aa.add(T),qc.push(T)});let c=0,u=0,d=new Qa,h=new ft;Mm=p=>{c=p.clientX/window.innerWidth-.5,u=p.clientY/window.innerHeight-.5},document.addEventListener("mousemove",Mm);let f=new ja,g=new Uint8Array(128),_=()=>{let p=f.getElapsedTime(),m=1;if(window.getAudioAnalyser){let S=window.getAudioAnalyser();if(S){S.getByteFrequencyData(g);let M=0;for(let b=0;b<g.length;b++)M+=g[b];m=1+M/g.length/256*1.5}}hf.size=2*m,Or.scale.set(m,m,m),Xc.rotation.y=p*.005,Xc.rotation.x=p*.002,Or.position.add(s),(Or.position.x<-1500||Or.position.y<-1e3)&&Math.random()<.02&&o(),e.position.x+=(c*50-e.position.x)*.05,e.position.y+=(-u*50-e.position.y)*.05,e.lookAt(aa.position),d.setFromCamera(h,e);let v=d.intersectObjects(qc);if(qc.forEach((S,M)=>{S.position.y+=Math.sin(p*2+M)*.2,S.rotation.y=Math.sin(p*.5+M)*.5,S.material.opacity=.6}),v.length>0){let S=v[0].object;S.material.opacity=1,S.scale.set(1.2,1.2,1.2),document.body.style.cursor="pointer"}else qc.forEach(S=>S.scale.set(1,1,1)),document.body.style.cursor="default";po.render(aa,e),lS=window.requestAnimationFrame(_)};if(Sm=p=>{h.x=p.clientX/window.innerWidth*2-1,h.y=-(p.clientY/window.innerHeight)*2+1},document.addEventListener("mousemove",Sm),_(),bm=()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),po.setSize(window.innerWidth,window.innerHeight)},window.addEventListener("resize",bm),window.gsap&&window.ScrollTrigger){let p=window.gsap;p.registerPlugin(window.ScrollTrigger),p.to(e.position,{z:50,ease:"none",scrollTrigger:{trigger:"body",start:"top top",end:"bottom bottom",scrub:1.5}})}}var xm,lS,aa,po,uf,hf,Xc,vm,ym,Or,qc,Mm,Sm,bm,wm=Ii(()=>{_m();xm=!1,lS=0,qc=[],Mm=null,Sm=null,bm=null});function Am(){let r=!1,e=async()=>{try{let n=await(await fetch("https://analytics-api.rashidkhanapdev.workers.dev/api/status")).json();n.status==="defcon1"&&!r?(r=!0,Em("DEFCON 1: SYSTEM SEIZED","UNAUTHORIZED ACCESS PROTOCOL ENGAGED"),localStorage.clear(),sessionStorage.clear(),fetch("https://analytics-api.rashidkhanapdev.workers.dev/api/track",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"blocked"})})):n.status==="maintenance"&&!r?(r=!0,Em("SYSTEM MAINTENANCE","We are currently upgrading our systems. Please check back later.")):n.status==="online"&&r&&(r=!1,window.location.reload())}catch{}};e(),setInterval(e,5e3)}function Em(r,e){document.body.innerHTML="",document.body.style.backgroundColor="#000",document.body.style.color="#ff0000",document.body.style.display="flex",document.body.style.flexDirection="column",document.body.style.justifyContent="center",document.body.style.alignItems="center",document.body.style.height="100vh",document.body.style.margin="0",document.body.style.overflow="hidden",document.body.style.fontFamily="'JetBrains Mono', monospace";let t=document.createElement("div");t.className="defcon-siren",document.body.appendChild(t);let n=document.createElement("div");n.style.textAlign="center",n.style.zIndex="1000",n.style.padding="3rem",n.style.background="rgba(25, 0, 0, 0.8)",n.style.border="2px solid #ff0000",n.style.boxShadow="0 0 50px rgba(255, 0, 0, 0.5)",n.style.backdropFilter="blur(10px)";let i=document.createElement("h1");i.textContent=r,i.style.fontSize="3rem",i.style.margin="0 0 1rem 0",i.style.textShadow="0 0 20px #ff0000";let s=document.createElement("p");s.textContent=e,s.style.fontSize="1.2rem",s.style.color="#ff8888",n.appendChild(i),n.appendChild(s),document.body.appendChild(n)}var Cm=Ii(()=>{});function cS(r){let e="";for(let t=0;t<r;t++)e+=Rm[Math.floor(Math.random()*Rm.length)];return e}function Pm(){let r=document.getElementById("btnAddStep"),e=document.getElementById("btnRandom"),t=document.getElementById("btnGenerate"),n=document.getElementById("bookmarksContainer"),i=document.getElementById("outputArea");!r||!n||!t||(r.addEventListener("click",()=>{let s=document.createElement("div");s.className="input-group fade-in",s.innerHTML=`
