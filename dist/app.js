...
`].filter(uo).join(`
`)),a=rf(a),a=jp(a,t),a=em(a,t),o=rf(o),o=jp(o,t),o=em(o,t),a=tm(a),o=tm(o),t.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
}`,UM=[new W(1,0,0),new W(-1,0,0),new W(0,1,0),new W(0,-1,0),new W(0,0,1),new W(0,0,-1)],OM=[new W(0,-1,0),new W(0,-1,0),new W(0,0,1),new W(0,0,-1),new W(0,-1,0),new W(0,-1,0)],am=new Ut,co=new W,Qh=new W;GM=`
void main() {
