...
`)+`
`+m);let b=v+p+a,M=v+m+o,w=jp(i,i.VERTEX_SHADER,b),S=jp(i,i.FRAGMENT_SHADER,M);i.attachShader(_,w),i.attachShader(_,S),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(P){if(r.debug.checkShaderErrors){let I=i.getProgramInfoLog(_)||"",V=i.getShaderInfoLog(w)||"",O=i.getShaderInfoLog(S)||"",L=I.trim(),U=V.trim(),F=O.trim(),Y=!0,j=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,w,S);else{let D=tm(i,w,"vertex"),de=tm(i,S,"fragment");Ve("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
