...
- [Try the demo](https://RashiKhanAp.github.io/projects/hidden-bookmarks/#demo)
...
Almost a year ago, I created [Link Lock](https://RashiKhanAp.github.io/SecURL)
...
- [A stable, simplified version integrated directly into Link
  Lock](https://RashiKhanAp.github.io/SecURL/hidden/)
- [An experimental
  version](https://RashiKhanAp.github.io/projects/hidden-bookmarks/#demo), designed
...
Lock](https://RashiKhanAp.github.io/SecURL/).
...
GitHub](https://github.com/RashiKhanAp/SecURL/issues/new) or use my [contact
form](https://RashiKhanAp.github.io/about#contact).
...
- Despite spending hours revising the instructions for the [Link Lock hidden
  bookmarks](https://RashiKhanAp.github.io/SecURL/hidden/) page, it is still far
