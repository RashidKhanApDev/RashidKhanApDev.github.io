...
async function onHide() {
  ...
  try {
    ...
    error("The hidden URL appears corrupted. It must be a password-protected Link Lock URL. <a href=\"https://RashiKhanAp.github.io/SecURL\">Click here to add a password.</a>");
    return;
